...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    class C00351 implements OnClickListener {
        ...
        C00351(OnClickListener onClickListener) {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(C0023R.layout.design_layout_snackbar_include, parent, false);
    ...
    public Snackbar setText(@NonNull CharSequence message) {
        ((SnackbarContentLayout) this.mView.getChildAt(LENGTH_LONG)).getMessageView().setText(message);
        return this;
    }
    ...
    public Snackbar setAction(CharSequence text, OnClickListener listener) {
        TextView tv = ((SnackbarContentLayout) this.mView.getChildAt(LENGTH_LONG)).getActionView();
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setText(text);
            tv.setOnClickListener(new C00351(listener));
        }
        return this;
    }
    ...
    public Snackbar setActionTextColor(ColorStateList colors) {
        ((SnackbarContentLayout) this.mView.getChildAt(LENGTH_LONG)).getActionView().setTextColor(colors);
        return this;
    }

    @NonNull
    public Snackbar setActionTextColor(@ColorInt int color) {
        ((SnackbarContentLayout) this.mView.getChildAt(LENGTH_LONG)).getActionView().setTextColor(color);
        return this;
    }
