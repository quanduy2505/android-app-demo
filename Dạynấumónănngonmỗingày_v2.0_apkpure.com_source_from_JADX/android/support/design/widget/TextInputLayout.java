...
public class TextInputLayout extends LinearLayout {
    ...
    class C00384 implements OnClickListener {
        C00384() {
        }
    ...
    class C08575 implements AnimatorUpdateListener {
        C08575() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C08581 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08581() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C08581());
        }
    }
    ...
    class C12942 extends ViewPropertyAnimatorListenerAdapter {
        C12942() {
        }
    ...
    class C12953 extends ViewPropertyAnimatorListenerAdapter {
        final /* synthetic */ CharSequence val$error;

        C12953(CharSequence charSequence) {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0023R.styleable.TextInputLayout, defStyleAttr, C0023R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0023R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0023R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0023R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0023R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0023R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0023R.styleable.TextInputLayout_hintTextAppearance, INVALID_MAX_LENGTH) != INVALID_MAX_LENGTH) {
            setHintTextAppearance(a.getResourceId(C0023R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0023R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0023R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0023R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0023R.styleable.TextInputLayout_counterMaxLength, INVALID_MAX_LENGTH));
        this.mCounterTextAppearance = a.getResourceId(C0023R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0023R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = a.getBoolean(C0023R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = a.getDrawable(C0023R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = a.getText(C0023R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(C0023R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = a.getColorStateList(C0023R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(C0023R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0023R.styleable.TextInputLayout_passwordToggleTintMode, INVALID_MAX_LENGTH), null);
        }
        a.recycle();
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00371());
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0023R.id.textinput_error);
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0181R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0023R.color.design_textinput_error_color_light));
                }
    ...
    private void setError(@Nullable CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C12942()).start();
            } else {
                ViewCompat.setAlpha(this.mErrorView, 1.0f);
            }
        } else if (this.mErrorView.getVisibility() == 0) {
            if (animate) {
                ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new C12953(error)).start();
            } else {
                this.mErrorView.setText(error);
                this.mErrorView.setVisibility(4);
            }
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0023R.id.textinput_counter);
                if (this.mTypeface != null) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0181R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0023R.color.design_textinput_error_color_light));
                }
    ...
    void updateCounter(int length) {
        ...
        if (this.mCounterMaxLength == INVALID_MAX_LENGTH) {
            ...
            this.mCounterView.setText(getContext().getString(C0023R.string.character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0023R.layout.design_text_input_password_icon, this.mInputFrame, false);
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C00384());
                }
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C08575());
            }
