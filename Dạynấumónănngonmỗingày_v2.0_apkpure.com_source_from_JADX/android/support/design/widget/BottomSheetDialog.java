...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C08422 extends AccessibilityDelegateCompat {
        C08422() {
        }
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (BottomSheetDialog.this.mCancelable) {
                info.addAction((int) AccessibilityNodeInfoCompat.ACTION_DISMISS);
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            if (action != AccessibilityNodeInfoCompat.ACTION_DISMISS || !BottomSheetDialog.this.mCancelable) {
    ...
    class C08433 extends BottomSheetCallback {
        C08433() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C08433();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        CoordinatorLayout coordinator = (CoordinatorLayout) View.inflate(getContext(), C0023R.layout.design_bottom_sheet_dialog, null);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0023R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0023R.id.touch_outside).setOnClickListener(new C00311());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C08422());
        return coordinator;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0023R.attr.bottomSheetDialogTheme, outValue, true)) {
