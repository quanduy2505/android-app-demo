    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (childLpHeight == -1 || childLpHeight == -2) {
            ...
            if (header != null) {
                ...
                parent.onMeasureChild(child, parentWidthMeasureSpec, widthUsed, MeasureSpec.makeMeasureSpec((availableHeight - header.getMeasuredHeight()) + getScrollRange(header), childLpHeight == -1 ? 1073741824 : Target.SIZE_ORIGINAL), heightUsed);
                return true;
            }
        }
        return false;
