...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C08301 implements OnApplyWindowInsetsListener {
        C08301() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0023R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0023R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0023R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08301());
    }
