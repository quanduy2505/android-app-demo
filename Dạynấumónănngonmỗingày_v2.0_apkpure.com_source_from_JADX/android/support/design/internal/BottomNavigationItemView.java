...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mItemPosition = INVALID_ITEM_POSITION;
        Resources res = getResources();
        int inactiveLabelSize = res.getDimensionPixelSize(C0023R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C0023R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C0023R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0023R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0023R.drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0023R.id.icon);
        this.mSmallLabel = (TextView) findViewById(C0023R.id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0023R.id.largeLabel);
    }
