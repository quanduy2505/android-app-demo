...
class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case C0801R.styleable.AppCompatTheme_imageButtonStyle /*65*/:
                case C0801R.styleable.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                    incr = 7;
                    break;
                case C0801R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                case C0801R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle /*99*/:
                    incr = 6;
                    break;
                case C0801R.styleable.AppCompatTheme_listPreferredItemHeightLarge /*72*/:
                case C0801R.styleable.AppCompatTheme_colorControlNormal /*86*/:
                case C0801R.styleable.AppCompatTheme_checkboxStyle /*104*/:
                case 'v':
                    incr = 1;
                    break;
                case C0801R.styleable.AppCompatTheme_listPopupWindowStyle /*76*/:
                case C0801R.styleable.AppCompatTheme_textAppearanceListItem /*77*/:
                case C0801R.styleable.AppCompatTheme_colorPrimaryDark /*84*/:
                case C0801R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                case C0801R.styleable.AppCompatTheme_ratingBarStyleIndicator /*109*/:
                case 't':
                    incr = 2;
                    break;
                case C0801R.styleable.AppCompatTheme_panelMenuListTheme /*81*/:
                case C0801R.styleable.AppCompatTheme_colorPrimary /*83*/:
                case C0801R.styleable.AppCompatTheme_switchStyle /*113*/:
                case 's':
                    incr = 4;
                    break;
                case C0801R.styleable.AppCompatTheme_colorSwitchThumbNormal /*90*/:
                case 'z':
                    path.close();
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            for (int i = 0; i < numSegments; i++) {
                ...
                f = (float) e1x;
                f = (float) e1y;
                p.rCubicTo(((float) (e1x + (alpha * ep1x))) - r0, ((float) (e1y + (alpha * ep1y))) - r0, ((float) (e2x - (alpha * ep2x))) - r0, ((float) (e2y - (alpha * ep2y))) - r0, ((float) e2x) - ((float) e1x), ((float) e2y) - ((float) e1y));
                eta1 = eta2;
                e1x = e2x;
                e1y = e2y;
                ep1x = ep2x;
        ...
        for (currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case C0801R.styleable.AppCompatTheme_actionDropDownStyle /*46*/:
                    ...
                    result.mEndWithNegOrDot = true;
                    break;
                case C0801R.styleable.AppCompatTheme_searchViewStyle /*69*/:
