...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00473 extends AnimatorListenerAdapter {
        C00473() {
        }
    ...
    /* renamed from: android.support.transition.ChangeBoundsPort.4 */
    class C00484 extends AnimatorListenerAdapter {
        ...
        C00484(ViewGroup viewGroup, BitmapDrawable bitmapDrawable, View view) {
        ...
        public void onAnimationEnd(Animator animation) {
            ViewOverlay.createFrom(this.val$sceneRoot).remove(this.val$drawable);
            this.val$view.setVisibility(0);
        }
    }

    /* renamed from: android.support.transition.ChangeBoundsPort.1 */
    class C12961 extends TransitionListenerAdapter {
        boolean mCanceled;
    ...
    class C12972 extends TransitionListenerAdapter {
        boolean mCanceled;
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C12972());
                    }
                    anim.addListener(new C00473());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
        ...
        if (!(startX == endX && startY == endY)) {
            ...
            Rect[] rectArr = new Object[]{rect, endBounds1};
            anim = ObjectAnimator.ofObject(drawable, "bounds", sRectEvaluator, rectArr);
            anim.addListener(new C00484(sceneRoot, drawable, view));
            return anim;
        }
        return null;
    }
