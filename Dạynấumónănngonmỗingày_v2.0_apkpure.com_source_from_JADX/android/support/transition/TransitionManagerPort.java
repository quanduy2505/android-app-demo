...
class TransitionManagerPort {
    ...
    private static class MultiListener implements OnPreDrawListener, OnAttachStateChangeListener {
        ...
        class C12991 extends TransitionListenerAdapter {
            final /* synthetic */ ArrayMap val$runningTransitions;

            C12991(ArrayMap arrayMap) {
        ...
        public boolean onPreDraw() {
            removeListeners();
            TransitionManagerPort.sPendingTransitions.remove(this.mSceneRoot);
            ArrayMap<ViewGroup, ArrayList<TransitionPort>> runningTransitions = TransitionManagerPort.getRunningTransitions();
            ...
            this.mTransition.addListener(new C12991(runningTransitions));
