...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    class C01911 implements OnGlobalLayoutListener {
        C01911() {
        }
    ...
    class C09162 implements MenuItemHoverListener {
        ...
        class C01921 implements Runnable {
            ...
            C01921(CascadingMenuInfo cascadingMenuInfo, MenuItem menuItem, MenuBuilder menuBuilder) {
        ...
        public void onItemHoverEnter(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
            ...
            if (menuIndex != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new C01921(nextInfo, item, menu), menu, SystemClock.uptimeMillis() + 200);
            }
        }
    }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mGlobalLayoutListener = new C01911();
        this.mMenuItemHoverListener = new C09162();
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0181R.dimen.abc_config_prefDialogWidth));
    ...
    private int getNextMenuPosition(int nextMenuWidth) {
        ...
        if (this.mLastPosition == HORIZ_POSITION_RIGHT) {
            if ((screenLocation[HORIZ_POSITION_LEFT] + lastListView.getWidth()) + nextMenuWidth > displayFrame.right) {
                return HORIZ_POSITION_LEFT;
            }
            return HORIZ_POSITION_RIGHT;
        } else if (screenLocation[HORIZ_POSITION_LEFT] - nextMenuWidth < 0) {
            return HORIZ_POSITION_RIGHT;
        } else {
            return HORIZ_POSITION_LEFT;
        }
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            View titleItemView = (FrameLayout) inflater.inflate(C0181R.layout.abc_popup_menu_header_item_layout, listView, false);
