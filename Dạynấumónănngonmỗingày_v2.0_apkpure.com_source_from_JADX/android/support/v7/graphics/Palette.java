...
public final class Palette {
    ...
    public static final class Builder {
        ...
        class C01841 extends AsyncTask<Bitmap, Void, Palette> {
            final /* synthetic */ PaletteAsyncListener val$listener;

            C01841(PaletteAsyncListener paletteAsyncListener) {
        ...
        public AsyncTask<Bitmap, Void, Palette> generate(PaletteAsyncListener listener) {
            ...
            return AsyncTaskCompat.executeParallel(new C01841(listener), this.mBitmap);
        }
            ...
            if (!this.mGeneratedTextColors) {
                ...
                if (lightBodyAlpha == -1 || lightTitleAlpha == -1) {
                    ...
                    if (darkBodyAlpha == -1 || darkBodyAlpha == -1) {
                        this.mBodyTextColor = lightBodyAlpha != -1 ? ColorUtils.setAlphaComponent(-1, lightBodyAlpha) : ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, darkBodyAlpha);
                        this.mTitleTextColor = lightTitleAlpha != -1 ? ColorUtils.setAlphaComponent(-1, lightTitleAlpha) : ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, darkTitleAlpha);
    ...
    static class C09101 implements Filter {
