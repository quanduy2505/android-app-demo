...
class AppCompatDelegateImplV14 extends AppCompatDelegateImplV11 {
    ...
    final class AutoNightModeManager {
        ...
        final void setup() {
            ...
            if (this.mAutoTimeChangeReceiver == null) {
                this.mAutoTimeChangeReceiver = new C01761();
            }
    ...
    private boolean shouldRecreateOnNightModeChange() {
        ...
        try {
            if ((this.mContext.getPackageManager().getActivityInfo(new ComponentName(this.mContext, this.mContext.getClass()), 0).configChanges & AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY) == 0) {
                return true;
            }
            return false;
