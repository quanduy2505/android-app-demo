...
class AlertController {
    ...
    class C01694 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01694(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    class C01705 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01705(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C01711 extends ArrayAdapter<CharSequence> {
            ...
            C01711(Context x0, int x1, int x2, CharSequence[] x3, RecycleListView recycleListView) {
        ...
        class C01722 extends CursorAdapter {
            ...
            C01722(Context x0, Cursor x1, boolean x2, RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
        ...
        class C01733 implements OnItemClickListener {
            ...
            C01733(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C01744 implements OnItemClickListener {
            ...
            C01744(RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C01711(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c01722 = new C01722(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C01733(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C01744(listView, dialog));
            }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0181R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0181R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0181R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    class C09032 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C09032(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0181R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        this.mButtonHandler = new C01671();
        this.mContext = context;
        this.mDialog = di;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(di);
        TypedArray a = context.obtainStyledAttributes(null, C0181R.styleable.AlertDialog, C0181R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0181R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0181R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0181R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0181R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0181R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0181R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0181R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View spacer;
        View parentPanel = this.mWindow.findViewById(C0181R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0181R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0181R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0181R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0181R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0181R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0181R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0181R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            spacer = contentPanel.findViewById(C0181R.id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!((this.mMessage == null && this.mListView == null && !hasCustomPanel) || hasCustomPanel)) {
                divider = topPanel.findViewById(C0181R.id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            spacer = contentPanel.findViewById(C0181R.id.textSpacerNoTitle);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0181R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0181R.id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C09032(top, bottom));
                this.mScrollView.post(new C01683(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C01694(top, bottom));
                this.mListView.post(new C01705(top, bottom));
            } else {
                if (top != null) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0181R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0181R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0181R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0181R.id.scrollView);
