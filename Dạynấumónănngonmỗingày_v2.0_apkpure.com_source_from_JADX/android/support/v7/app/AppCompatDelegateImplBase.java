...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class C01751 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        C01751(UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null, new int[]{C0181R.attr.homeAsUpIndicator});
        ...
        public boolean isNavigationVisible() {
            ...
            return (ab == null || (ab.getDisplayOptions() & 4) == 0) ? AppCompatDelegateImplBase.DEBUG : true;
        }
    ...
    class AppCompatWindowCallbackBase extends WindowCallbackWrapper {
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
            return (AppCompatDelegateImplBase.this.dispatchKeyEvent(event) || super.dispatchKeyEvent(event)) ? true : AppCompatDelegateImplBase.DEBUG;
        }

        public boolean dispatchKeyShortcutEvent(KeyEvent event) {
            return (super.dispatchKeyShortcutEvent(event) || AppCompatDelegateImplBase.this.onKeyShortcut(event.getKeyCode(), event)) ? true : AppCompatDelegateImplBase.DEBUG;
        }
        ...
        public boolean onPreparePanel(int featureId, View view, Menu menu) {
            ...
            mb.setOverrideVisibleItems(AppCompatDelegateImplBase.DEBUG);
            return handled;
        }
    ...
    static {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new C01751(Thread.getDefaultUncaughtExceptionHandler()));
