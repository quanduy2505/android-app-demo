...
public class NotificationCompat extends android.support.v4.app.NotificationCompat {
    ...
    private static CharSequence makeMessageLine(android.support.v4.app.NotificationCompat.Builder b, MessagingStyle style, Message m) {
        ...
        if (TextUtils.isEmpty(m.getSender())) {
            if (style.getUserDisplayName() == null) {
                replyName = BuildConfig.VERSION_NAME;
            } else {
        ...
        sb.append("  ").append(bidi.unicodeWrap(m.getText() == null ? BuildConfig.VERSION_NAME : m.getText()));
        return sb;
    }
    ...
    private static void addBigStyleToBuilderLollipop(Notification n, android.support.v4.app.NotificationCompat.Builder b) {
        ...
        if ((b.mStyle instanceof DecoratedMediaCustomViewStyle) && innerView != null) {
            ...
            NotificationCompatImplBase.overrideMediaBigContentView(notification, b.mContext, b.mContentTitle, b.mContentText, b.mContentInfo, b.mNumber, b.mLargeIcon, b.mSubText, b.mUseChronometer, b.getWhenIfShowing(), b.getPriority(), 0, b.mActions, false, null, true);
            NotificationCompatImplBase.buildIntoRemoteViews(b.mContext, n.bigContentView, innerView);
    ...
    private static void setBackgroundColor(Context context, RemoteViews views, int color) {
        if (color == 0) {
            color = context.getResources().getColor(C0181R.color.notification_material_background_media_default_color);
        }
        views.setInt(C0181R.id.status_bar_latest_event_content, "setBackgroundColor", color);
    }
