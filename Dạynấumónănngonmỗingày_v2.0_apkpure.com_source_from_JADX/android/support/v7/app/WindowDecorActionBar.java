...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C09093 implements ViewPropertyAnimatorUpdateListener {
        C09093() {
        }
    ...
    class C13051 extends ViewPropertyAnimatorListenerAdapter {
        C13051() {
        }
    ...
    class C13062 extends ViewPropertyAnimatorListenerAdapter {
        C13062() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C13051();
        this.mShowListener = new C13062();
        this.mUpdateListener = new C09093();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0181R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0181R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0181R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0181R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0181R.styleable.ActionBar, C0181R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0181R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0181R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0181R.attr.actionBarWidgetTheme, outValue, true);
