...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setView(View view) {
            this.f0P.mView = view;
            this.f0P.mViewLayoutResId = AlertDialog.LAYOUT_HINT_NONE;
            this.f0P.mViewSpacingSpecified = false;
            return this;
        }
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int resid) {
        if (resid >= AccessibilityEventCompat.TYPE_ASSIST_READING_CONTEXT) {
            return resid;
        }
        TypedValue outValue = new TypedValue();
        context.getTheme().resolveAttribute(C0181R.attr.alertDialogTheme, outValue, true);
