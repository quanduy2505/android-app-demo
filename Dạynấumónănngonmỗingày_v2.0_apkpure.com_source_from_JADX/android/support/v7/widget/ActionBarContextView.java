...
public class ActionBarContextView extends AbsActionBarView {
    ...
    class C01961 implements OnClickListener {
        final /* synthetic */ ActionMode val$mode;

        C01961(ActionMode actionMode) {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0181R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0181R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0181R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0181R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0181R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0181R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0181R.styleable.ActionMode_closeItemLayout, C0181R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0181R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0181R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0181R.id.action_bar_subtitle);
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(C0181R.id.action_mode_close_button).setOnClickListener(new C01961(mode));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            int childSpecHeight = MeasureSpec.makeMeasureSpec(height, Target.SIZE_ORIGINAL);
            if (this.mClose != null) {
            ...
            if (this.mCustomView != null) {
                ...
                int i = lp2.width;
                int customWidthMode = r0 != -2 ? 1073741824 : Target.SIZE_ORIGINAL;
                if (lp2.width >= 0) {
                ...
                i = lp2.height;
                int customHeightMode = r0 != -2 ? 1073741824 : Target.SIZE_ORIGINAL;
                if (lp2.height >= 0) {
