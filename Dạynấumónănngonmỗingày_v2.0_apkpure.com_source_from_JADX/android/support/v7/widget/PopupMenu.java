...
public class PopupMenu {
    ...
    class C02162 implements android.widget.PopupWindow.OnDismissListener {
        C02162() {
        }
    ...
    class C09271 implements Callback {
        C09271() {
        }
    ...
    class C09283 extends ForwardingListener {
        C09283(View src) {
            super(src);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0181R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C09271());
        ...
        this.mPopup.setOnDismissListener(new C02162());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C09283(this.mAnchor);
        }
