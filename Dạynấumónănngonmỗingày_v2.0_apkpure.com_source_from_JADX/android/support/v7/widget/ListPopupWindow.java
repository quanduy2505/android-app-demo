...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C02153 implements OnItemSelectedListener {
        C02153() {
        }
    ...
    class C09241 extends ForwardingListener {
        C09241(View src) {
            super(src);
        }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0181R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        this.mListItemExpandMaximum = UrlImageViewHelper.CACHE_DURATION_INFINITE;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0181R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0181R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0181R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            int firstItem = UrlImageViewHelper.CACHE_DURATION_INFINITE;
            int lastItem = Target.SIZE_ORIGINAL;
            if (adapter != null) {
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02142();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02153());
            ...
            if (hintView != null) {
                ...
                if (this.mDropDownWidth >= 0) {
                    widthMode = Target.SIZE_ORIGINAL;
        ...
        switch (this.mDropDownWidth) {
            case WRAP_CONTENT /*-2*/:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Target.SIZE_ORIGINAL);
                break;
            case MATCH_PARENT /*-1*/:
