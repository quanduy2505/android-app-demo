...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C02384 implements Runnable {
        ...
        C02384(RecoverAnimation recoverAnimation, int i) {
    ...
    public static abstract class Callback {
        ...
        static class C02391 implements Interpolator {
            C02391() {
            }
        ...
        static class C02402 implements Interpolator {
            C02402() {
            }
        ...
        static {
            sDragScrollInterpolator = new C02391();
            sDragViewScrollCapInterpolator = new C02402();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0187R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public long getAnimationDuration(RecyclerView recyclerView, int animationType, float animateDx, float animateDy) {
            ...
            if (itemAnimator == null) {
                return animationType == ItemTouchHelper.RIGHT ? 200 : 250;
            } else {
                if (animationType == ItemTouchHelper.RIGHT) {
    ...
    private class ItemTouchHelperGestureListener extends SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (child != null) {
                ...
                if (vh != null && ItemTouchHelper.this.mCallback.hasDragFlag(ItemTouchHelper.this.mRecyclerView, vh) && e.getPointerId(ItemTouchHelper.ACTION_STATE_IDLE) == ItemTouchHelper.this.mActivePointerId) {
    ...
    class C09382 implements OnItemTouchListener {
        C09382() {
        }
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == 0) {
                ItemTouchHelper.this.mActivePointerId = event.getPointerId(ItemTouchHelper.ACTION_STATE_IDLE);
    ...
    class C09395 implements ChildDrawingOrderCallback {
        C09395() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C09401 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C09401(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C09401(ItemTouchHelper.this));
    ...
    class C13173 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C13173(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY, int i, ViewHolder viewHolder2) {
            this.val$swipeDir = i;
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0187R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0187R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    RecoverAnimation rv = new C13173(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY, swipeDir, prevSelected);
    ...
    void postDispatchSwipe(RecoverAnimation anim, int swipeDir) {
        this.mRecyclerView.post(new C02384(anim, swipeDir));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C09395();
            }
