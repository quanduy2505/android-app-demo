...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    class AnchorInfo {
        ...
        void saveSpanReferenceLines(Span[] spans) {
            ...
            for (int i = StaggeredGridLayoutManager.HORIZONTAL; i < spanCount; i += StaggeredGridLayoutManager.VERTICAL) {
                this.mSpanReferenceLines[i] = spans[i].getStartLine(StaggeredGridLayoutManager.INVALID_OFFSET);
            }
        }
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            static class C02311 implements Creator<FullSpanItem> {
                C02311() {
                }
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C02321 implements Creator<SavedState> {
            C02321() {
            }
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mCheckForGapsRunnable = new C02301();
    ...
    private void fixStartGap(Recycler recycler, State state, boolean canOffsetChildren) {
        int minStartLine = getMinStart(UrlImageViewHelper.CACHE_DURATION_INFINITE);
        if (minStartLine != UrlImageViewHelper.CACHE_DURATION_INFINITE) {
    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            if (layoutState.mLayoutDirection == VERTICAL) {
                targetLine = UrlImageViewHelper.CACHE_DURATION_INFINITE;
            } else {
    ...
    private Span getNextSpan(LayoutState layoutState) {
        ...
        if (layoutState.mLayoutDirection == VERTICAL) {
            Span min = null;
            int minLine = UrlImageViewHelper.CACHE_DURATION_INFINITE;
    ...
    public void collectAdjacentPrefetchPositions(int dx, int dy, State state, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        if (getChildCount() != 0 && delta != 0) {
            ...
            for (i = HORIZONTAL; i < this.mSpanCount && this.mLayoutState.hasMore(state); i += VERTICAL) {
