...
class ActivityChooserModel extends DataSetObservable {
        ...
        public Void doInBackground(Object... args) {
            ...
            try {
                ...
                try {
                    ...
                    serializer.startDocument(HTTP.UTF_8, Boolean.valueOf(true));
    ...
    private void readHistoricalDataImpl() {
        ...
        r3 = 0;
        r0 = r18;
        r15 = r0.mContext;	 Catch:{ FileNotFoundException -> 0x0024 }
        r0 = r18;
        r0 = r0.mHistoryFileName;	 Catch:{ FileNotFoundException -> 0x0024 }
        r16 = r0;
        r3 = r15.openFileInput(r16);	 Catch:{ FileNotFoundException -> 0x0024 }
        r8 = android.util.Xml.newPullParser();	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r15 = "UTF-8";
        r8.setInput(r3, r15);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r12 = 0;
    L_0x0019:
        r15 = 1;
        if (r12 == r15) goto L_0x0026;
    L_0x001c:
        r15 = 2;
        if (r12 == r15) goto L_0x0026;
    L_0x001f:
        r12 = r8.next();	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        goto L_0x0019;
    L_0x0024:
        r4 = move-exception;
    L_0x0025:
    ...
    L_0x0026:
        ...
        r16 = r8.getName();	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r15 = r15.equals(r16);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        if (r15 != 0) goto L_0x0063;
    L_0x0032:
        r15 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r16 = "Share records file does not start with historical-records tag.";
        r15.<init>(r16);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        throw r15;	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
    L_0x003a:
        r14 = move-exception;
        r15 = LOG_TAG;	 Catch:{ all -> 0x00ea }
        r16 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00ea }
        r16.<init>();	 Catch:{ all -> 0x00ea }
        r17 = "Error reading historical recrod file: ";
        r16 = r16.append(r17);	 Catch:{ all -> 0x00ea }
        r0 = r18;
        r0 = r0.mHistoryFileName;	 Catch:{ all -> 0x00ea }
        r17 = r0;
        r16 = r16.append(r17);	 Catch:{ all -> 0x00ea }
        r16 = r16.toString();	 Catch:{ all -> 0x00ea }
        r0 = r16;
        android.util.Log.e(r15, r0, r14);	 Catch:{ all -> 0x00ea }
    ...
    L_0x0063:
        r0 = r18;
        r5 = r0.mHistoricalRecords;	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r5.clear();	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
    L_0x006a:
        r12 = r8.next();	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r15 = 1;
    ...
    L_0x007c:
        ...
        if (r12 == r15) goto L_0x006a;
    L_0x007f:
        r7 = r8.getName();	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r15 = "historical-record";
        r15 = r15.equals(r7);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
    ...
    L_0x0093:
        ...
        r16 = r16.toString();	 Catch:{ all -> 0x00ea }
        r0 = r16;
        android.util.Log.e(r15, r0, r6);	 Catch:{ all -> 0x00ea }
        if (r3 == 0) goto L_0x0025;
    L_0x00b6:
    ...
    L_0x00be:
        ...
        r16 = "activity";
        r0 = r16;
        r2 = r8.getAttributeValue(r15, r0);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r15 = 0;
        r16 = "time";
        r0 = r16;
        r15 = r8.getAttributeValue(r15, r0);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r10 = java.lang.Long.parseLong(r15);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r15 = 0;
        r16 = "weight";
        r0 = r16;
        r15 = r8.getAttributeValue(r15, r0);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r13 = java.lang.Float.parseFloat(r15);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r9 = new android.support.v7.widget.ActivityChooserModel$HistoricalRecord;	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r9.<init>(r2, r10, r13);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        r5.add(r9);	 Catch:{ XmlPullParserException -> 0x003a, IOException -> 0x0093 }
        goto L_0x006a;
    L_0x00ea:
        r15 = move-exception;
