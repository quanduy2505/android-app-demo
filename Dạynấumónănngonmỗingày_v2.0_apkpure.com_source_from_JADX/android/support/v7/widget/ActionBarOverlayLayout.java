...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C13081 extends ViewPropertyAnimatorListenerAdapter {
        C13081() {
        }
    ...
    static {
        ATTRS = new int[]{C0181R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C13081();
        this.mRemoveActionBarHideOffset = new C01972();
        this.mAddActionBarHideOffset = new C01983();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0181R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0181R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0181R.id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, Target.SIZE_ORIGINAL, UrlImageViewHelper.CACHE_DURATION_INFINITE);
