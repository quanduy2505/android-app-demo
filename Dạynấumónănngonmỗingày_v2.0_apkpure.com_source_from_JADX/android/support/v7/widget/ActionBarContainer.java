...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0181R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0181R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0181R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0181R.styleable.ActionBar_height, -1);
        if (getId() == C0181R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0181R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0181R.id.action_bar);
        this.mContextView = findViewById(C0181R.id.action_context_bar);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (this.mActionBarView == null && MeasureSpec.getMode(heightMeasureSpec) == Target.SIZE_ORIGINAL && this.mHeight >= 0) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(this.mHeight, MeasureSpec.getSize(heightMeasureSpec)), Target.SIZE_ORIGINAL);
        }
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + topMarginForTabs, mode == Target.SIZE_ORIGINAL ? MeasureSpec.getSize(heightMeasureSpec) : UrlImageViewHelper.CACHE_DURATION_INFINITE));
            }
        }
    }
