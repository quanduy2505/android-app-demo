...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C02101 implements OnAttachStateChangeListener {
        C02101() {
        }
    ...
    class C02112 implements OnGlobalLayoutListener {
        boolean mIsAttached;
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C02101());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C02112());
    }
