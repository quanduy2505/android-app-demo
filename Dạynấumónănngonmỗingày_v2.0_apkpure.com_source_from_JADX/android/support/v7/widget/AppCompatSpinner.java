...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C09201 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C09201(View src, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C02041 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C02041(AppCompatSpinner appCompatSpinner) {
        ...
        class C02052 implements OnGlobalLayoutListener {
            C02052() {
            }
        ...
        class C02063 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C02063(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C02041(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C02052();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C02063(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0181R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0181R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0181R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C0181R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0181R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                this.mDropDownWidth = pa.getLayoutDimension(C0181R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0181R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0181R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C09201(this, popup);
            }
        }
        CharSequence[] entries = a.getTextArray(C0181R.styleable.Spinner_android_entries);
        if (entries != null) {
            SpinnerAdapter adapter = new ArrayAdapter(context, 17367048, entries);
            adapter.setDropDownViewResource(C0181R.layout.support_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
        a.recycle();
        this.mPopupSet = true;
