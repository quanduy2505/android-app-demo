...
public class Toolbar extends ViewGroup {
    ...
    class C09361 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C09361() {
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                lp.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & C0801R.styleable.AppCompatTheme_spinnerStyle);
                lp.mViewType = 2;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C09371 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C09371() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C09371());
        }
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0181R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C09361();
        this.mShowOverflowMenuRunnable = new C02342();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0181R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0181R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0181R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0181R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = a.getInteger(C0181R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_titleMargin, 0);
        if (a.hasValue(C0181R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        int marginStart = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0181R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_contentInsetStart, Target.SIZE_ORIGINAL);
        int contentInsetEnd = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_contentInsetEnd, Target.SIZE_ORIGINAL);
        int contentInsetLeft = a.getDimensionPixelSize(C0181R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0181R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_contentInsetStartWithNavigation, Target.SIZE_ORIGINAL);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0181R.styleable.Toolbar_contentInsetEndWithActions, Target.SIZE_ORIGINAL);
        this.mCollapseIcon = a.getDrawable(C0181R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0181R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0181R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0181R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0181R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0181R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0181R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable logo = a.getDrawable(C0181R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        CharSequence logoDesc = a.getText(C0181R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C0181R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(a.getColor(C0181R.styleable.Toolbar_titleTextColor, -1));
        }
        if (a.hasValue(C0181R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0181R.styleable.Toolbar_subtitleTextColor, -1));
        }
        a.recycle();
    }
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = GravityCompat.END | (this.mButtonGravity & C0801R.styleable.AppCompatTheme_spinnerStyle);
    ...
    public int getContentInsetStartWithNavigation() {
        if (this.mContentInsetStartWithNavigation != Target.SIZE_ORIGINAL) {
    ...
    public void setContentInsetStartWithNavigation(int insetStartWithNavigation) {
        if (insetStartWithNavigation < 0) {
            insetStartWithNavigation = Target.SIZE_ORIGINAL;
        }
    ...
    public int getContentInsetEndWithActions() {
        if (this.mContentInsetEndWithActions != Target.SIZE_ORIGINAL) {
    ...
    public void setContentInsetEndWithActions(int insetEndWithActions) {
        if (insetEndWithActions < 0) {
            insetEndWithActions = Target.SIZE_ORIGINAL;
        }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0181R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = GravityCompat.START | (this.mButtonGravity & C0801R.styleable.AppCompatTheme_spinnerStyle);
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0181R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C02353());
        }
    }
    ...
    private int getChildTop(View child, int alignmentHeight) {
        ...
        switch (getChildVerticalGravity(lp.gravity)) {
            ...
            case C0801R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & C0801R.styleable.AppCompatTheme_spinnerStyle;
        switch (vgrav) {
            ...
            case C0801R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
                return vgrav;
            default:
                return this.mGravity & C0801R.styleable.AppCompatTheme_spinnerStyle;
        }
    }
