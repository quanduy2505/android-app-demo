...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02244 implements OnFocusChangeListener {
        C02244() {
        }
    ...
    class C02255 implements OnLayoutChangeListener {
        C02255() {
        }
    ...
    class C02266 implements OnGlobalLayoutListener {
        C02266() {
        }
    ...
    class C02288 implements OnKeyListener {
        C02288() {
        }
    ...
    class C02299 implements OnEditorActionListener {
        C02299() {
        }
    ...
    private static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            boolean sendToDelegate = SearchView.DBG;
            boolean hit = true;
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C09341 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C09341() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C09341());
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0181R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0181R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C02211();
        this.mUpdateDrawableStateRunnable = new C02222();
        this.mReleaseCursorRunnable = new C02233();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02277();
        this.mTextKeyListener = new C02288();
        this.mOnEditorActionListener = new C02299();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0181R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0181R.styleable.SearchView_layout, C0181R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0181R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0181R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0181R.id.search_plate);
        this.mSubmitArea = findViewById(C0181R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0181R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0181R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0181R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0181R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0181R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0181R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0181R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0181R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0181R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0181R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0181R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0181R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0181R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0181R.styleable.SearchView_suggestionRowLayout, C0181R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0181R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02244());
        setIconifiedByDefault(a.getBoolean(C0181R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0181R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0181R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0181R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0181R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0181R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0181R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C02255());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02266());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0181R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0181R.dimen.abc_search_view_preferred_height);
    }
    ...
    private boolean hasVoiceSearch() {
        ...
        if (testIntent == null || getContext().getPackageManager().resolveActivity(testIntent, NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST) == null) {
            return DBG;
        }
        return true;
    }
    ...
    boolean onSuggestionsKey(View v, int keyCode, KeyEvent event) {
        ...
        if (keyCode != 21 && keyCode != 22) {
            return (keyCode == 19 && this.mSearchSrcTextView.getListSelection() == 0) ? DBG : DBG;
        } else {
            int selPoint;
            if (keyCode == 21) {
                selPoint = 0;
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = (inputType | NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST) | AccessibilityNodeInfoCompat.ACTION_COLLAPSE;
            }
        }
        this.mSearchSrcTextView.setInputType(inputType);
    ...
    void onCloseClicked() {
        if (!TextUtils.isEmpty(this.mSearchSrcTextView.getText())) {
            this.mSearchSrcTextView.setText(BuildConfig.VERSION_NAME);
    ...
    public void onActionViewCollapsed() {
        setQuery(BuildConfig.VERSION_NAME, DBG);
        clearFocus();
        updateViewsVisibility(true);
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0181R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0181R.dimen.abc_dropdownitem_text_padding_left) : 0;
