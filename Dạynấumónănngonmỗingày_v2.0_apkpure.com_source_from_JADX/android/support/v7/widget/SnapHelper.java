...
public abstract class SnapHelper extends OnFlingListener {
    ...
    class C09351 extends OnScrollListener {
        boolean mScrolled;
    ...
    class C13152 extends LinearSmoothScroller {
        C13152(Context context) {
            super(context);
        }
    ...
    public SnapHelper() {
        this.mScrollListener = new C09351();
    }
    ...
    public int[] calculateScrollDistance(int velocityX, int velocityY) {
        outDist = new int[2];
        this.mGravityScroller.fling(0, 0, velocityX, velocityY, Target.SIZE_ORIGINAL, UrlImageViewHelper.CACHE_DURATION_INFINITE, Target.SIZE_ORIGINAL, UrlImageViewHelper.CACHE_DURATION_INFINITE);
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        if (layoutManager instanceof ScrollVectorProvider) {
            return new C13152(this.mRecyclerView.getContext());
        }
        return null;
    }
}
