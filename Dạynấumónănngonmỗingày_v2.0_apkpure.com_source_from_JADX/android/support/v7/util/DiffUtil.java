...
public class DiffUtil {
    ...
    static class C01881 implements Comparator<Snake> {
        C01881() {
        }
    ...
    public static class DiffResult {
        ...
        class C09131 implements ListUpdateCallback {
            final /* synthetic */ Adapter val$adapter;

            C09131(Adapter adapter) {
        ...
        public void dispatchUpdatesTo(Adapter adapter) {
            dispatchUpdatesTo(new C09131(adapter));
        }
        ...
        public void dispatchUpdatesTo(ListUpdateCallback updateCallback) {
            ...
            for (int snakeIndex = this.mSnakes.size() - 1; snakeIndex >= 0; snakeIndex--) {
                ...
                for (int i = snakeSize - 1; i >= 0; i--) {
                    if ((this.mOldItemStatuses[snake.f3x + i] & FLAG_MASK) == FLAG_CHANGED) {
                        batchingCallback.onChanged(snake.f3x + i, FLAG_NOT_CHANGED, this.mCallback.getChangePayload(snake.f3x + i, snake.f4y + i));
                    }
                }
                posOld = snake.f3x;
                posNew = snake.f4y;
