...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C09141 implements MainThreadCallback<T> {
        ...
        class C01891 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C09141.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C09141.UPDATE_ITEM_COUNT /*1*/:
                            C09141.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C09141.ADD_TILE /*2*/:
                            C09141.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C09141.REMOVE_TILE /*3*/:
                            C09141.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C09141.this.mQueue.next();
                }
            }
        }

        C09141(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01891();
        }
    ...
    class C09152 implements BackgroundCallback<T> {
        ...
        class C01901 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C09152.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C09152.REFRESH /*1*/:
                                C09152.this.mQueue.removeMessages(C09152.REFRESH);
                                C09152.this.val$callback.refresh(msg.arg1);
                                break;
                            case C09152.UPDATE_RANGE /*2*/:
                                C09152.this.mQueue.removeMessages(C09152.UPDATE_RANGE);
                                C09152.this.mQueue.removeMessages(C09152.LOAD_TILE);
                                C09152.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C09152.LOAD_TILE /*3*/:
                                C09152.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C09152.RECYCLE_TILE /*4*/:
                                C09152.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C09152.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C09152(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01901();
        }
