...
public class AsyncListUtil<T> {
    ...
    class C09111 implements MainThreadCallback<T> {
        C09111() {
        }
    ...
    class C09122 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C09111();
        this.mBackgroundCallback = new C09122();
        this.mTClass = klass;
