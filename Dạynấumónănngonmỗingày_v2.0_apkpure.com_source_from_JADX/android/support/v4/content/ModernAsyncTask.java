...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00761 implements ThreadFactory {
    ...
    class C00773 extends FutureTask<Result> {
        C00773(Callable x0) {
            super(x0);
        }
    ...
    class C08682 extends WorkerRunnable<Params, Result> {
        C08682() {
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C08682();
        this.mFuture = new C00773(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00784.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
