...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C09021 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C09021() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C09021());
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            if (!isInEditMode()) {
                ...
                heightMode = Target.SIZE_ORIGINAL;
        ...
        for (i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                i2 = lp.width;
                if (r0 == -2) {
                    childWidthSpec = MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, Target.SIZE_ORIGINAL);
                } else {
                    i2 = lp.width;
                    if (r0 == -1) {
                ...
                i2 = lp.height;
                if (r0 == -2) {
                    childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, Target.SIZE_ORIGINAL);
                } else {
                    i2 = lp.height;
                    if (r0 == -1) {
