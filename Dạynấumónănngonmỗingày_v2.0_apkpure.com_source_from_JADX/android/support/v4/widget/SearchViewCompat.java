...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C09001 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListener val$listener;

            C09001(OnQueryTextListener onQueryTextListener) {
        ...
        class C09012 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListener val$listener;

            C09012(OnCloseListener onCloseListener) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListener listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C09001(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListener listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C09012(listener));
        }
