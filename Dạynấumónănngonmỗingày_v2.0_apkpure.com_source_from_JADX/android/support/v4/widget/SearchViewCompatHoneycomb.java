...
class SearchViewCompatHoneycomb {
    ...
    static class C01541 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01541(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01552 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01552(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
