...
public class ViewDragHelper {
    ...
    static class C01641 implements Interpolator {
        C01641() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        this.mSetIdleRunnable = new C01652();
        if (forParent == null) {
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(PointerIconCompat.TYPE_DEFAULT, this.mMaxVelocity);
