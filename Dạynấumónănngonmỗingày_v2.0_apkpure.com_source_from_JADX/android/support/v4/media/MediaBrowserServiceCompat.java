...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceBinderImpl {
        ...
        class C00921 implements Runnable {
            ...
            C00921(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00932 implements Runnable {
            ...
            C00932(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00943 implements Runnable {
            ...
            C00943(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
        ...
        class C00954 implements Runnable {
            ...
            C00954(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$token = iBinder;
            }
        ...
        class C00965 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;
            final /* synthetic */ String val$mediaId;
            final /* synthetic */ ResultReceiver val$receiver;

            C00965(ServiceCallbacks serviceCallbacks, String str, ResultReceiver resultReceiver) {
                this.val$callbacks = serviceCallbacks;
        ...
        class C00976 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;
            final /* synthetic */ Bundle val$rootHints;

            C00976(ServiceCallbacks serviceCallbacks, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$rootHints = bundle;
            }
        ...
        class C00987 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;

            C00987(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00921(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00932(callbacks));
        }

        public void addSubscription(String id, IBinder token, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00943(callbacks, id, token, options));
        }

        public void removeSubscription(String id, IBinder token, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00954(callbacks, id, token));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver, ServiceCallbacks callbacks) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00965(callbacks, mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks, Bundle rootHints) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00976(callbacks, rootHints));
        }

        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00987(callbacks));
        }
    }
    ...
    class C08701 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C08701(Object debug, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C08712 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C08712(Object debug, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(debug);
        }
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, ServiceCompatProxy {
        ...
        class C00891 implements Runnable {
            ...
            C00891(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        class C08722 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C08722(Object debug, ResultWrapper resultWrapper) {
        ...
        public void notifyChildrenChanged(String parentId, Bundle options) {
            if (this.mMessenger == null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.post(new C00891(parentId, options));
            }
        }
        ...
        public void onLoadChildren(String parentId, ResultWrapper<List<Parcel>> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C08722(parentId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        class C00912 implements Runnable {
            ...
            C00912(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        public void setSessionToken(Token token) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00901(token));
        }

        public void notifyChildrenChanged(@NonNull String parentId, Bundle options) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00912(parentId, options));
        }
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        class C08731 extends Result<MediaItem> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C08731(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadItem(String itemId, ResultWrapper<Parcel> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadItem(itemId, new C08731(itemId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy {
        ...
        class C08741 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C08741(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadChildren(String parentId, ResultWrapper resultWrapper, Bundle options) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C08741(parentId, resultWrapper), options);
        }
    ...
    void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C08701(parentId, connection, parentId, options);
    ...
    void performLoadItem(String itemId, ConnectionRecord connection, ResultReceiver receiver) {
        Result<MediaItem> result = new C08712(itemId, receiver);
        this.mCurConnection = connection;
