...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C01131 implements Creator<QueueItem> {
            C01131() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C01141 implements Creator<ResultReceiverWrapper> {
            C01141() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C01151 implements Creator<Token> {
            C01151() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0801R.styleable.AppCompatTheme_panelBackground /*79*/:
                        case C0801R.styleable.AppCompatTheme_colorAccent /*85*/:
                            boolean isPlaying;
                        ...
                        case C0801R.styleable.AppCompatTheme_colorControlActivated /*87*/:
                            if ((32 & validActions) != 0) {
                                cb.onSkipToNext();
                            }
                        case C0801R.styleable.AppCompatTheme_colorControlHighlight /*88*/:
                            if ((16 & validActions) != 0) {
                                cb.onSkipToPrevious();
                            }
                        case C0801R.styleable.AppCompatTheme_colorButtonNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                            }
        ...
        class C08781 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C08781() {
            }
        ...
        class C13012 implements Callback {
            C13012() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent) {
            ...
            this.mVolumeCallback = new C08781();
