...
public final class PlaybackStateCompat implements Parcelable {
    ...
    static class C01171 implements Creator<PlaybackStateCompat> {
        C01171() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        static class C01181 implements Creator<CustomAction> {
            C01181() {
            }
    ...
    public static int toKeyCode(long action) {
        ...
        if (action == ACTION_SKIP_TO_NEXT) {
            return 87;
        }
        if (action == ACTION_SKIP_TO_PREVIOUS) {
            return 88;
        }
        if (action == ACTION_STOP) {
            return 86;
        }
        if (action == ACTION_FAST_FORWARD) {
            return 90;
        }
