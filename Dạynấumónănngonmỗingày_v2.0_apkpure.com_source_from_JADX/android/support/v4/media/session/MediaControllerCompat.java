...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        class C01101 extends ResultReceiver {
            C01101(Handler x0) {
                super(x0);
            }
        ...
        private class ExtraCallback extends Stub {
            ...
            class C01111 implements Runnable {
                ...
                C01111(String str, Bundle bundle) {
                    this.val$event = str;
            ...
            class C01122 implements Runnable {
                ...
                C01122(PlaybackStateCompat playbackStateCompat) {
            ...
            public void onEvent(String event, Bundle extras) throws RemoteException {
                this.mCallback.mHandler.post(new C01111(event, extras));
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat state) throws RemoteException {
                this.mCallback.mHandler.post(new C01122(state));
            }
        ...
        private void requestExtraBinder() {
            sendCommand(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER, null, new C01101(new Handler()));
        }
    }
