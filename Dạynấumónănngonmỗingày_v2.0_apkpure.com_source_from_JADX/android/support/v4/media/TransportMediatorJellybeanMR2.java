...
class TransportMediatorJellybeanMR2 {
    ...
    class C01031 implements OnWindowAttachListener {
        C01031() {
        }
    ...
    class C01042 implements OnWindowFocusChangeListener {
        C01042() {
        }
    ...
    class C01053 extends BroadcastReceiver {
        C01053() {
        }
    ...
    class C01064 implements OnAudioFocusChangeListener {
        C01064() {
        }
    ...
    class C01075 implements OnGetPlaybackPositionListener {
        C01075() {
        }
    ...
    class C01086 implements OnPlaybackPositionUpdateListener {
        C01086() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C01031();
        this.mWindowFocusListener = new C01042();
        this.mMediaButtonReceiver = new C01053();
        this.mAudioFocusChangeListener = new C01064();
        this.mGetPlaybackPositionListener = new C01075();
        this.mPlaybackPositionUpdateListener = new C01086();
        this.mPlayState = 0;
