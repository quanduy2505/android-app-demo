...
public class TransportMediator extends TransportController {
    ...
    class C01022 implements Callback {
        C01022() {
        }
    ...
    class C08751 implements TransportMediatorCallback {
        C08751() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C08751();
        this.mKeyEventCallback = new C01022();
