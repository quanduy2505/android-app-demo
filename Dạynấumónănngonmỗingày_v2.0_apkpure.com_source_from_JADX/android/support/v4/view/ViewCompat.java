...
public class ViewCompat {
    ...
    static class BaseViewCompatImpl implements ViewCompatImpl {
        ...
        public void setChildrenDrawingOrderEnabled(ViewGroup viewGroup, boolean enabled) {
            if (sChildrenDrawingOrderMethod == null) {
                try {
                    Class[] clsArr = new Class[ViewCompat.SCROLL_INDICATOR_TOP];
                    clsArr[ViewCompat.SCROLL_AXIS_NONE] = Boolean.TYPE;
            ...
            try {
                ...
                Object[] objArr = new Object[ViewCompat.SCROLL_INDICATOR_TOP];
                objArr[ViewCompat.SCROLL_AXIS_NONE] = Boolean.valueOf(enabled);
    ...
    static class LollipopViewCompatImpl extends KitKatViewCompatImpl {
        ...
        /* renamed from: android.support.v4.view.ViewCompat.LollipopViewCompatImpl.1 */
        class C08901 implements OnApplyWindowInsetsListenerBridge {
            final /* synthetic */ OnApplyWindowInsetsListener val$listener;

            C08901(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
                this.val$listener = onApplyWindowInsetsListener;
            }

            public Object onApplyWindowInsets(View v, Object insets) {
                return WindowInsetsCompat.unwrap(this.val$listener.onApplyWindowInsets(v, WindowInsetsCompat.wrap(insets)));
            }
        }
        ...
        public void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener listener) {
            if (listener == null) {
                ...
                ViewCompatLollipop.setOnApplyWindowInsetsListener(view, new C08901(listener));
            }
        }
