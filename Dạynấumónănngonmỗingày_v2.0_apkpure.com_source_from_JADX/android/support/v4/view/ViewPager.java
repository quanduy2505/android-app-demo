...
public class ViewPager extends ViewGroup {
    ...
    static class C01381 implements Comparator<ItemInfo> {
        C01381() {
        }
    ...
    static class C01392 implements Interpolator {
        C01392() {
        }
    ...
    class C01403 implements Runnable {
        C01403() {
        }
    ...
    class C08914 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C08921 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08921() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C08921());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01381();
        sInterpolator = new C01392();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01403();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08914());
    }
    ...
    public void setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        setPageTransformer(reverseDrawingOrder, transformer, SCROLL_STATE_SETTLING);
    }
    ...
    private void enableLayers(boolean enable) {
        int childCount = getChildCount();
        for (int i = SCROLL_STATE_IDLE; i < childCount; i += SCROLL_STATE_DRAGGING) {
            ViewCompat.setLayerType(getChildAt(i), enable ? this.mPageTransformerLayerType : SCROLL_STATE_IDLE, null);
        }
    }
