...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C08831 extends AbsSavedState {
        C08831() {
            super();
        }
    }
    ...
    static class C08842 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C08842() {
        }
    ...
    static {
        EMPTY_STATE = new C08831();
        CREATOR = ParcelableCompat.newCreator(new C08842());
    }
