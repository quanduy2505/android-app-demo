...
public class CustomViewPager extends ViewGroup {
    ...
    /* renamed from: android.support.v4.view.CustomViewPager.1 */
    static class C01321 implements Comparator<ItemInfo> {
        C01321() {
        }
    ...
    /* renamed from: android.support.v4.view.CustomViewPager.2 */
    static class C01332 implements Interpolator {
        C01332() {
        }
    ...
    /* renamed from: android.support.v4.view.CustomViewPager.3 */
    class C01343 implements Runnable {
        C01343() {
        }

        public void run() {
            CustomViewPager.this.setScrollState(CustomViewPager.SCROLL_STATE_IDLE);
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams() {
            super(CustomViewPager.INVALID_POINTER, CustomViewPager.INVALID_POINTER);
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.gravity = a.getInteger(CustomViewPager.SCROLL_STATE_IDLE, 48);
            a.recycle();
        }
    }

    public interface OnAdapterChangeListener {
        void onAdapterChanged(@NonNull CustomViewPager customViewPager, @Nullable PagerAdapter pagerAdapter, @Nullable PagerAdapter pagerAdapter2);
    }
    ...
    static class ViewPositionComparator implements Comparator<View> {
        ...
        public int compare(View lhs, View rhs) {
            ...
            if (llp.isDecor != rlp.isDecor) {
                return llp.isDecor ? CustomViewPager.SCROLL_STATE_DRAGGING : CustomViewPager.INVALID_POINTER;
            } else {
    ...
    /* renamed from: android.support.v4.view.CustomViewPager.4 */
    class C08874 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
        ...
        public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat originalInsets) {
            ...
            int count = CustomViewPager.this.getChildCount();
            for (int i = CustomViewPager.SCROLL_STATE_IDLE; i < count; i += CustomViewPager.SCROLL_STATE_DRAGGING) {
                WindowInsetsCompat childInsets = ViewCompat.dispatchApplyWindowInsets(CustomViewPager.this.getChildAt(i), applied);
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT && CustomViewPager.this.mAdapter != null) {
                recordCompat.setItemCount(CustomViewPager.this.mAdapter.getCount());
                recordCompat.setFromIndex(CustomViewPager.this.mCurItem);
                recordCompat.setToIndex(CustomViewPager.this.mCurItem);
            }
        }
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (CustomViewPager.this.canScrollHorizontally(CustomViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction((int) ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT);
            }
            if (CustomViewPager.this.canScrollHorizontally(CustomViewPager.INVALID_POINTER)) {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            switch (action) {
                case ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT /*4096*/:
                    ...
                    CustomViewPager.this.setCurrentItem(CustomViewPager.this.mCurItem + CustomViewPager.SCROLL_STATE_DRAGGING);
                    return true;
                case Utility.DEFAULT_STREAM_BUFFER_SIZE /*8192*/:
                    if (!CustomViewPager.this.canScrollHorizontally(CustomViewPager.INVALID_POINTER)) {
                        return CustomViewPager.DEBUG;
                    }
                    CustomViewPager.this.setCurrentItem(CustomViewPager.this.mCurItem + CustomViewPager.INVALID_POINTER);
                    return true;
                default:
                    return CustomViewPager.DEBUG;
            }
        ...
        private boolean canScroll() {
            return (CustomViewPager.this.mAdapter == null || CustomViewPager.this.mAdapter.getCount() <= CustomViewPager.SCROLL_STATE_DRAGGING) ? CustomViewPager.DEBUG : true;
        }
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        /* renamed from: android.support.v4.view.CustomViewPager.SavedState.1 */
        static class C08881 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08881() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C08881());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01321();
        sInterpolator = new C01332();
    ...
    public CustomViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01343();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08874());
    }
    ...
    L_0x0105:
        ...
        r0 = r26;
        r16 = r0.get(r8);
        r16 = (android.support.v4.view.CustomViewPager.ItemInfo) r16;
        r0 = r16;
        r0 = r0.position;
        r26 = r0;
        r0 = r29;
    ...
    L_0x0152:
        ...
        r1 = r17;
        r26 = r0.get(r1);
        r26 = (android.support.v4.view.CustomViewPager.ItemInfo) r26;
        r16 = r26;
    L_0x0164:
    ...
    L_0x0200:
        ...
        r19 = (android.support.v4.view.CustomViewPager.LayoutParams) r19;
        r0 = r19;
        r0.childIndex = r15;
        r0 = r19;
        r0 = r0.isDecor;
    ...
    L_0x0472:
        ...
        goto L_0x0428;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.CustomViewPager.populate(int):void");
    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    android.support.v4.view.CustomViewPager.ItemInfo infoForAnyChild(android.view.View r3) {
        /*
        r2 = this;
    L_0x0000:
        r0 = r3.getParent();
    ...
    L_0x0012:
        ...
        goto L_0x000d;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.CustomViewPager.infoForAnyChild(android.view.View):android.support.v4.view.CustomViewPager$ItemInfo");
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0801R.styleable.AppCompatTheme_spinnerStyle;
                    int widthMode = com.bumptech.glide.request.target.Target.SIZE_ORIGINAL;
                    int heightMode = com.bumptech.glide.request.target.Target.SIZE_ORIGINAL;
            ...
            if (this.mAdapter.getCount() != 0) {
                ...
                switch (action & MotionEventCompat.ACTION_MASK) {
                    ...
                    case SCROLL_STATE_SETTLING /*2*/:
                        ...
                        if (this.mIsBeingDragged) {
                            needsInvalidate = DEBUG | performDrag(ev.getX(ev.findPointerIndex(this.mActivePointerId)));
                            break;
                        }
                        break;
                    case ConnectionResult.SERVICE_DISABLED /*3*/:
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case C0801R.styleable.AppCompatTheme_popupMenuStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (currentFocused == this) {
            ...
            for (CustomViewPager parent = currentFocused.getParent(); parent instanceof ViewGroup; parent = parent.getParent()) {
                if (parent == this) {
                    isChild = true;
                    break;
                }
