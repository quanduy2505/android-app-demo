...
class ViewCompatLollipop {
    ...
    static class C01371 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListenerBridge val$bridge;

        C01371(OnApplyWindowInsetsListenerBridge onApplyWindowInsetsListenerBridge) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListenerBridge bridge) {
        if (bridge == null) {
            ...
            view.setOnApplyWindowInsetsListener(new C01371(bridge));
        }
    }
