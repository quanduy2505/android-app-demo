...
class FragmentTransitionCompat21 {
    ...
    static class C00661 extends EpicenterCallback {
    ...
    static class C00672 implements TransitionListener {
        final /* synthetic */ ArrayList val$exitingViews;
        final /* synthetic */ View val$fragmentView;

        C00672(View view, ArrayList arrayList) {
    ...
    static class C00683 implements Runnable {
        ...
        C00683(int i, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
    ...
    static class C00694 implements Runnable {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C00694(ArrayList arrayList, Map map) {
            this.val$sharedElementsIn = arrayList;
    ...
    static class C00705 implements TransitionListener {
        ...
        C00705(Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3) {
    ...
    static class C00716 extends EpicenterCallback {
        final /* synthetic */ Rect val$epicenter;
    ...
    static class C00727 implements Runnable {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C00727(ArrayList arrayList, Map map) {
            this.val$sharedElementsIn = arrayList;
            this.val$nameOverrides = map;
        }
    ...
    public static void setEpicenter(Object transitionObj, View view) {
        if (view != null) {
            ...
            transition.setEpicenterCallback(new C00661(epicenter));
        }
    }
    ...
    public static void scheduleHideFragmentView(Object exitTransitionObj, View fragmentView, ArrayList<View> exitingViews) {
        ((Transition) exitTransitionObj).addListener(new C00672(fragmentView, exitingViews));
    }
    ...
    public static void setNameOverridesOptimized(View sceneRoot, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, ArrayList<String> inNames, Map<String, String> nameOverrides) {
        ...
        OneShotPreDrawListener.add(sceneRoot, new C00683(numSharedElements, sharedElementsIn, inNames, sharedElementsOut, outNames));
    }
    ...
    public static void setNameOverridesUnoptimized(View sceneRoot, ArrayList<View> sharedElementsIn, Map<String, String> nameOverrides) {
        OneShotPreDrawListener.add(sceneRoot, new C00694(sharedElementsIn, nameOverrides));
    }
    ...
    public static void scheduleRemoveTargets(Object overallTransitionObj, Object enterTransition, ArrayList<View> enteringViews, Object exitTransition, ArrayList<View> exitingViews, Object sharedElementTransition, ArrayList<View> sharedElementsIn) {
        ((Transition) overallTransitionObj).addListener(new C00705(enterTransition, enteringViews, exitTransition, exitingViews, sharedElementTransition, sharedElementsIn));
    }
    ...
    public static void setEpicenter(Object transitionObj, Rect epicenter) {
        if (transitionObj != null) {
            ((Transition) transitionObj).setEpicenterCallback(new C00716(epicenter));
        }
    }

    public static void scheduleNameReset(ViewGroup sceneRoot, ArrayList<View> sharedElementsIn, Map<String, String> nameOverrides) {
        OneShotPreDrawListener.add(sceneRoot, new C00727(sharedElementsIn, nameOverrides));
    }
}
