...
public final class LinkifyCompat {
    ...
    static class C01281 implements Comparator<LinkSpec> {
        C01281() {
        }
    ...
    public static final boolean addLinks(@NonNull Spannable spannable, @NonNull Pattern pattern, @Nullable String defaultScheme, @Nullable String[] schemes, @Nullable MatchFilter matchFilter, @Nullable TransformFilter transformFilter) {
        if (defaultScheme == null) {
            defaultScheme = BuildConfig.VERSION_NAME;
        }
        ...
        for (int index = 0; index < schemes.length; index++) {
            ...
            schemesCopy[index + 1] = scheme == null ? BuildConfig.VERSION_NAME : scheme.toLowerCase(Locale.ROOT);
        }
        ...
        while (true) {
            ...
            if (address != null) {
                ...
                if (start >= 0) {
                    ...
                    try {
                        spec.url = "geo:0,0?q=" + URLEncoder.encode(address, HTTP.UTF_8);
                        links.add(spec);
