...
public final class ReplaySubject<T> extends Subject<T, T> {
    ...
    static class C15721 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C15721(UnboundedReplayState unboundedReplayState) {
    ...
    static class C15732 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C15732(UnboundedReplayState unboundedReplayState) {
            this.val$state = unboundedReplayState;
        }
        ...
        L_0x000b:
            ...
            monitor-exit(r8);	 Catch:{ all -> 0x0047 }
            r4 = 0;
            r2 = r7.val$state;	 Catch:{ all -> 0x004f }
        L_0x0015:
    ...
    static class C15743 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C15743(UnboundedReplayState unboundedReplayState) {
            this.val$state = unboundedReplayState;
        }
    ...
    static class C15754 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ BoundedState val$state;

        C15754(BoundedState boundedState) {
    ...
    static class C15765 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ BoundedState val$state;

        C15765(BoundedState boundedState) {
            this.val$state = boundedState;
        }
    ...
    public static <T> ReplaySubject<T> create(int capacity) {
        ...
        ssm.onStart = new C15721(state);
        ssm.onAdded = new C15732(state);
        ssm.onTerminated = new C15743(state);
    ...
    static <T> ReplaySubject<T> createWithState(BoundedState<T> state, Action1<SubjectObserver<T>> onStart) {
        SubjectSubscriptionManager<T> ssm = new SubjectSubscriptionManager();
        ssm.onStart = onStart;
        ssm.onAdded = new C15754(state);
        ssm.onTerminated = new C15765(state);
        return new ReplaySubject(ssm, ssm, state);
    }
