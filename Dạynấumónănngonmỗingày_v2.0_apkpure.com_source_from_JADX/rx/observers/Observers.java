...
public final class Observers {
    ...
    static class C12801 implements Observer<Object> {
        C12801() {
        }
    ...
    static class C12812 implements Observer<T> {
        final /* synthetic */ Action1 val$onNext;

        C12812(Action1 action1) {
    ...
    static class C12823 implements Observer<T> {
        final /* synthetic */ Action1 val$onError;
        final /* synthetic */ Action1 val$onNext;

        C12823(Action1 action1, Action1 action12) {
    ...
    static class C12834 implements Observer<T> {
        final /* synthetic */ Action0 val$onComplete;
        final /* synthetic */ Action1 val$onError;
        final /* synthetic */ Action1 val$onNext;

        C12834(Action0 action0, Action1 action1, Action1 action12) {
    ...
    public static <T> Observer<T> create(Action1<? super T> onNext, Action1<Throwable> onError) {
        if (onNext == null) {
            ...
            return new C12823(onError, onNext);
        } else {
    ...
    public static <T> Observer<T> create(Action1<? super T> onNext, Action1<Throwable> onError, Action0 onComplete) {
        if (onNext == null) {
            ...
            return new C12834(onComplete, onError, onNext);
        } else {
