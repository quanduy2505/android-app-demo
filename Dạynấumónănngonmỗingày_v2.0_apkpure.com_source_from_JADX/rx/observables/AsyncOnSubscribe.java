...
public abstract class AsyncOnSubscribe<S, T> implements OnSubscribe<T> {
    ...
    static final class AsyncOuterManager<S, T> implements Producer, Subscription, Observer<Observable<? extends T>> {
        ...
        class C14761 extends Subscriber<T> {
            long remaining;
            final /* synthetic */ BufferUntilSubscriber val$buffer;
            final /* synthetic */ long val$expected;

            C14761(long j, BufferUntilSubscriber bufferUntilSubscriber) {
                this.val$expected = j;
        ...
        class C15622 implements Action0 {
            final /* synthetic */ Subscriber val$s;

            C15622(Subscriber subscriber) {
        ...
        private void subscribeBufferToObservable(Observable<? extends T> t) {
            ...
            Subscriber s = new C14761(this.expectedDelivery, buffer);
            this.subscriptions.add(s);
            t.doOnTerminate(new C15622(s)).subscribe(s);
    ...
    static class C14701 implements Func3<S, Long, Observer<Observable<? extends T>>, S> {
        final /* synthetic */ Action3 val$next;

        C14701(Action3 action3) {
    ...
    static class C14712 implements Func3<S, Long, Observer<Observable<? extends T>>, S> {
        final /* synthetic */ Action3 val$next;

        C14712(Action3 action3) {
            this.val$next = action3;
        }
    ...
    static class C14723 implements Func3<Void, Long, Observer<Observable<? extends T>>, Void> {
        final /* synthetic */ Action2 val$next;

        C14723(Action2 action2) {
    ...
    static class C14734 implements Func3<Void, Long, Observer<Observable<? extends T>>, Void> {
        final /* synthetic */ Action2 val$next;

        C14734(Action2 action2) {
            this.val$next = action2;
        }
    ...
    class C14757 implements Func1<Observable<T>, Observable<T>> {
        C14757() {
        }
    ...
    static class C15615 implements Action1<Void> {
        final /* synthetic */ Action0 val$onUnsubscribe;

        C15615(Action0 action0) {
    ...
    public static <S, T> AsyncOnSubscribe<S, T> createSingleState(Func0<? extends S> generator, Action3<? super S, Long, ? super Observer<Observable<? extends T>>> next) {
        return new AsyncOnSubscribeImpl((Func0) generator, new C14701(next));
    }
    ...
    public static <S, T> AsyncOnSubscribe<S, T> createSingleState(Func0<? extends S> generator, Action3<? super S, Long, ? super Observer<Observable<? extends T>>> next, Action1<? super S> onUnsubscribe) {
        return new AsyncOnSubscribeImpl(generator, new C14712(next), onUnsubscribe);
    }
    ...
    public static <T> AsyncOnSubscribe<Void, T> createStateless(Action2<Long, ? super Observer<Observable<? extends T>>> next) {
        return new AsyncOnSubscribeImpl(new C14723(next));
    }
    ...
    public static <T> AsyncOnSubscribe<Void, T> createStateless(Action2<Long, ? super Observer<Observable<? extends T>>> next, Action0 onUnsubscribe) {
        return new AsyncOnSubscribeImpl(new C14734(next), new C15615(onUnsubscribe));
    }
    ...
    public final void call(Subscriber<? super T> actualSubscriber) {
        try {
            ...
            Subscriber<T> concatSubscriber = new C14746(actualSubscriber, outerProducer);
            subject.onBackpressureBuffer().concatMap(new C14757()).unsafeSubscribe(concatSubscriber);
