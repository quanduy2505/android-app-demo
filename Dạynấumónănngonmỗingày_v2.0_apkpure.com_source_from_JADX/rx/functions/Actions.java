...
public final class Actions {
    ...
    static class C13541 implements Func0<R> {
        final /* synthetic */ Action0 val$action;
        final /* synthetic */ Object val$result;

        C13541(Action0 action0, Object obj) {
    ...
    static class C13552 implements Func1<T1, R> {
        final /* synthetic */ Action1 val$action;
        final /* synthetic */ Object val$result;

        C13552(Action1 action1, Object obj) {
    ...
    static class C13563 implements Func2<T1, T2, R> {
        final /* synthetic */ Action2 val$action;
        final /* synthetic */ Object val$result;

        C13563(Action2 action2, Object obj) {
    ...
    static class C13574 implements Func3<T1, T2, T3, R> {
        final /* synthetic */ Action3 val$action;
        final /* synthetic */ Object val$result;

        C13574(Action3 action3, Object obj) {
    ...
    static class C13585 implements Func4<T1, T2, T3, T4, R> {
        final /* synthetic */ Action4 val$action;
        final /* synthetic */ Object val$result;

        C13585(Action4 action4, Object obj) {
    ...
    static class C13596 implements Func5<T1, T2, T3, T4, T5, R> {
        final /* synthetic */ Action5 val$action;
        final /* synthetic */ Object val$result;

        C13596(Action5 action5, Object obj) {
    ...
    static class C13607 implements Func6<T1, T2, T3, T4, T5, T6, R> {
        final /* synthetic */ Action6 val$action;
        final /* synthetic */ Object val$result;

        C13607(Action6 action6, Object obj) {
    ...
    static class C13618 implements Func7<T1, T2, T3, T4, T5, T6, T7, R> {
        final /* synthetic */ Action7 val$action;
        final /* synthetic */ Object val$result;

        C13618(Action7 action7, Object obj) {
    ...
    static class C13629 implements Func8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
        final /* synthetic */ Action8 val$action;
        final /* synthetic */ Object val$result;

        C13629(Action8 action8, Object obj) {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Func8<T1, T2, T3, T4, T5, T6, T7, T8, R> toFunc(Action8<T1, T2, T3, T4, T5, T6, T7, T8> action, R result) {
        return new C13629(action, result);
    }
