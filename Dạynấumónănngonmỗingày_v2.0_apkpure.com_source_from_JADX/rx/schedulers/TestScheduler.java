...
public class TestScheduler extends Scheduler {
    ...
    private final class InnerTestScheduler extends Worker {
        ...
        class C15682 implements Action0 {
            final /* synthetic */ TimedAction val$timedAction;

            C15682(TimedAction timedAction) {
                this.val$timedAction = timedAction;
            }
        ...
        InnerTestScheduler() {
            this.f41s = new BooleanSubscription();
        }

        public void unsubscribe() {
            this.f41s.unsubscribe();
        }

        public boolean isUnsubscribed() {
            return this.f41s.isUnsubscribed();
        }
        ...
        public Subscription schedule(Action0 action, long delayTime, TimeUnit unit) {
            ...
            return Subscriptions.create(new C15671(timedAction));
        }

        public Subscription schedule(Action0 action) {
            TimedAction timedAction = new TimedAction(this, 0, action);
            TestScheduler.this.queue.add(timedAction);
            return Subscriptions.create(new C15682(timedAction));
        }
