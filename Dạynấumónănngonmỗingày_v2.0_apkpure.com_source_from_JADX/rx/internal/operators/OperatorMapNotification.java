...
public final class OperatorMapNotification<T, R> implements Operator<R, T> {
    ...
    class C12651 implements Producer {
        ...
        C12651(MapNotificationSubscriber mapNotificationSubscriber) {
            this.val$parent = mapNotificationSubscriber;
        }

        public void request(long n) {
            this.val$parent.requestInner(n);
        }
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super R> child) {
        MapNotificationSubscriber<T, R> parent = new MapNotificationSubscriber(child, this.onNext, this.onError, this.onCompleted);
        child.add(parent);
        child.setProducer(new C12651(parent));
        return parent;
    }
}
