...
public final class OperatorSkipUntil<T, U> implements Operator<T, T> {
    ...
    class C14311 extends Subscriber<U> {
        final /* synthetic */ AtomicBoolean val$gate;
        final /* synthetic */ SerializedSubscriber val$s;

        C14311(AtomicBoolean atomicBoolean, SerializedSubscriber serializedSubscriber) {
    ...
    class C14322 extends Subscriber<T> {
        final /* synthetic */ AtomicBoolean val$gate;
        final /* synthetic */ SerializedSubscriber val$s;

        C14322(Subscriber x0, AtomicBoolean atomicBoolean, SerializedSubscriber serializedSubscriber) {
            this.val$gate = atomicBoolean;
            this.val$s = serializedSubscriber;
            super(x0);
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        Subscriber<U> u = new C14311(gate, s);
        child.add(u);
        this.other.unsafeSubscribe(u);
        return new C14322(child, gate, s);
    }
}
