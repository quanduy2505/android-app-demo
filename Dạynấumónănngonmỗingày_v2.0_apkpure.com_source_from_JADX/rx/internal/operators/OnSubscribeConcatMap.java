...
public final class OnSubscribeConcatMap<T, R> implements OnSubscribe<R> {
    ...
    /* renamed from: rx.internal.operators.OnSubscribeConcatMap.1 */
    class C12601 implements Producer {
        final /* synthetic */ ConcatMapSubscriber val$parent;

        C12601(ConcatMapSubscriber concatMapSubscriber) {
            this.val$parent = concatMapSubscriber;
        }
        ...
        void drain() {
            if (this.wip.getAndIncrement() == 0) {
                ...
                while (!this.actual.isUnsubscribed()) {
                    if (!this.active) {
                        Throwable ex;
                        if (delayErrorMode != OnSubscribeConcatMap.BOUNDARY || this.error.get() == null) {
    ...
    public void call(Subscriber<? super R> child) {
        ...
        ConcatMapSubscriber<T, R> parent = new ConcatMapSubscriber(s, this.mapper, this.prefetch, this.delayErrorMode);
        child.add(parent);
        child.add(parent.inner);
        child.setProducer(new C12601(parent));
