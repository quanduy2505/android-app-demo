...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C15491 implements Action0 {
            final /* synthetic */ OperatorWindowWithTime val$this$0;

            C15491(OperatorWindowWithTime operatorWindowWithTime) {
        ...
        class C15502 implements Action0 {
            C15502() {
            }
        ...
        public ExactSubscriber(Subscriber<? super Observable<T>> child, Worker worker) {
            ...
            child.add(Subscriptions.create(new C15491(OperatorWindowWithTime.this)));
        }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C15502(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C15511 implements Action0 {
            C15511() {
            }
        ...
        class C15522 implements Action0 {
            final /* synthetic */ CountedSerializedSubject val$chunk;

            C15522(CountedSerializedSubject countedSerializedSubject) {
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C15511(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
        ...
        void startNewChunk() {
            ...
            synchronized (this.guard) {
                ...
                try {
                    ...
                    this.worker.schedule(new C15522(chunk), OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
                } catch (Throwable e) {
                    onError(e);
                }
            }
