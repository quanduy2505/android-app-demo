...
public final class OperatorDebounceWithTime<T> implements Operator<T, T> {
    ...
    class C13931 extends Subscriber<T> {
        ...
        class C15261 implements Action0 {
            ...
            public void call() {
                C13931.this.state.emit(this.val$index, C13931.this.val$s, C13931.this.self);
            }
        }

        C13931(Subscriber x0, SerialSubscription serialSubscription, Worker worker, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            this.val$ssub.set(this.val$worker.schedule(new C15261(this.state.next(t)), OperatorDebounceWithTime.this.timeout, OperatorDebounceWithTime.this.unit));
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        s.add(worker);
        s.add(ssub);
        return new C13931(child, ssub, worker, s);
    }
}
