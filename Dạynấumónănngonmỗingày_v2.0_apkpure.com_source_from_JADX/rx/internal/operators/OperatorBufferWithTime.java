...
public final class OperatorBufferWithTime<T> implements Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C15231 implements Action0 {
            C15231() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C15231(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C15241 implements Action0 {
            C15241() {
            }
        ...
        class C15252 implements Action0 {
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C15241(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
        ...
        void startNewChunk() {
            ...
            synchronized (this) {
                ...
                this.inner.schedule(new C15252(chunk), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
            }
        }
