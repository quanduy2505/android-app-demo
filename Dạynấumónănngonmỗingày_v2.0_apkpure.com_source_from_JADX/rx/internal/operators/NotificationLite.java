...
public final class NotificationLite<T> {
    ...
    static class C08111 implements Serializable {
    ...
    static class C08122 implements Serializable {
    ...
    private static class OnErrorSentinel implements Serializable {
        ...
        public String toString() {
            return "Notification=>Error:" + this.f21e;
        }
    }
    ...
    static {
        ...
        ON_COMPLETED_SENTINEL = new C08111();
        ON_NEXT_NULL_SENTINEL = new C08122();
    }
    ...
    public boolean accept(Observer<? super T> o, Object n) {
        if (n == ON_COMPLETED_SENTINEL) {
            ...
            o.onError(((OnErrorSentinel) n).f21e);
            return true;
        } else {
            o.onNext(n);
            return false;
