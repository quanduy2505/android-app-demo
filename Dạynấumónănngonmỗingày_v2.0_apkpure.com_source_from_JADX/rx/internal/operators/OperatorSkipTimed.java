...
public final class OperatorSkipTimed<T> implements Operator<T, T> {
    ...
    class C14302 extends Subscriber<T> {
        ...
        C14302(Subscriber x0, AtomicBoolean atomicBoolean, Subscriber subscriber) {
    ...
    class C15371 implements Action0 {
        final /* synthetic */ AtomicBoolean val$gate;

        C15371(AtomicBoolean atomicBoolean) {
            this.val$gate = atomicBoolean;
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        worker.schedule(new C15371(gate), this.time, this.unit);
        return new C14302(child, gate, child);
    }
}
