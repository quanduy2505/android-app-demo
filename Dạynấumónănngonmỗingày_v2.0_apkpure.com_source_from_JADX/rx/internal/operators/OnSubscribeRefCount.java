...
public final class OnSubscribeRefCount<T> implements OnSubscribe<T> {
    ...
    class C13832 extends Subscriber<T> {
        final /* synthetic */ CompositeSubscription val$currentBase;
        final /* synthetic */ Subscriber val$subscriber;

        C13832(Subscriber x0, Subscriber subscriber, CompositeSubscription compositeSubscription) {
    ...
    class C15181 implements Action1<Subscription> {
        final /* synthetic */ Subscriber val$subscriber;
        final /* synthetic */ AtomicBoolean val$writeLocked;

        C15181(Subscriber subscriber, AtomicBoolean atomicBoolean) {
            this.val$subscriber = subscriber;
    ...
    class C15193 implements Action0 {
        final /* synthetic */ CompositeSubscription val$current;

        C15193(CompositeSubscription compositeSubscription) {
