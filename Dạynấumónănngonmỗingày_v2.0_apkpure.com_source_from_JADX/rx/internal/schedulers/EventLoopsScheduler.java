...
public final class EventLoopsScheduler extends Scheduler implements SchedulerLifecycle {
    ...
    private static class EventLoopWorker extends Worker {
        ...
        /* renamed from: rx.internal.schedulers.EventLoopsScheduler.EventLoopWorker.1 */
        class C15541 implements Action0 {
            final /* synthetic */ Action0 val$action;

            C15541(Action0 action0) {
        ...
        /* renamed from: rx.internal.schedulers.EventLoopsScheduler.EventLoopWorker.2 */
        class C15552 implements Action0 {
            final /* synthetic */ Action0 val$action;

            C15552(Action0 action0) {
                this.val$action = action0;
            }
        ...
        public Subscription schedule(Action0 action) {
            ...
            return this.poolWorker.scheduleActual(new C15541(action), 0, null, this.serial);
        }
        ...
        public Subscription schedule(Action0 action, long delayTime, TimeUnit unit) {
            ...
            return this.poolWorker.scheduleActual(new C15552(action), delayTime, unit, this.timed);
        }
    }
