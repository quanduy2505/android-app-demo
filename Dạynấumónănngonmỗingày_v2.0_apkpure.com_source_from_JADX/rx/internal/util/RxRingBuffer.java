...
public class RxRingBuffer implements Subscription {
    ...
    static class C14641 extends ObjectPool<Queue<Object>> {
        C14641() {
        }
    ...
    static class C14652 extends ObjectPool<Queue<Object>> {
        C14652() {
        }
    ...
    static {
        ...
        _size = TransportMediator.FLAG_KEY_MEDIA_NEXT;
        ...
        SIZE = _size;
        SPSC_POOL = new C14641();
        SPMC_POOL = new C14652();
    }
