...
public final class SpscLinkedArrayQueue<T> implements Queue<T> {
    ...
    static {
        MAX_LOOK_AHEAD_STEP = Integer.getInteger("jctools.spsc.max.lookahead.step", ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT).intValue();
        HAS_NEXT = new Object();
    }
    ...
    public final boolean offer(T e) {
        ...
        if (lvElement(buffer, calcWrappedOffset(((long) lookAheadStep) + index, mask)) == null) {
            ...
            AtomicReferenceArray<Object> atomicReferenceArray = buffer;
            long j = index;
            int i = offset;
            T t = e;
            resize(atomicReferenceArray, j, i, t, (long) mask);
            return true;
        }
    }
