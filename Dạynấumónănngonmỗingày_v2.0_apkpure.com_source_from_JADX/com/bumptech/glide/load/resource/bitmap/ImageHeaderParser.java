...
public class ImageHeaderParser {
    ...
    private static class StreamReader {
        ...
        public int getUInt16() throws IOException {
            return ((this.is.read() << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (this.is.read() & ImageHeaderParser.SEGMENT_START_ID);
        }
    ...
    static {
        ...
        try {
            bytes = JPEG_EXIF_SEGMENT_PREAMBLE.getBytes(HTTP.UTF_8);
