...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    private static final Queue<Options> OPTIONS_QUEUE;
    private static final String TAG = "Downsampler";
    private static final Set<ImageType> TYPES_THAT_USE_POOL;

    /* renamed from: com.bumptech.glide.load.resource.bitmap.Downsampler.1 */
    static class C13181 extends Downsampler {
        C13181() {
        }
    ...
    static class C13192 extends Downsampler {
        C13192() {
        }
    ...
    static class C13203 extends Downsampler {
        C13203() {
        }
...
*/
    ...
    static {
        TYPES_THAT_USE_POOL = EnumSet.of(ImageType.JPEG, ImageType.PNG_A, ImageType.PNG);
    ...
    private int getRoundedSampleSize(int degreesToRotate, int inWidth, int inHeight, int outWidth, int outHeight) {
        ...
        int targetWidth;
        int exactSampleSize;
        if (outHeight == Target.SIZE_ORIGINAL) {
        ...
        if (degreesToRotate == 90 || degreesToRotate == SubsamplingScaleImageView.ORIENTATION_270) {
