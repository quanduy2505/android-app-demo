...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C09671 implements PreloadModelProvider<T> {
        C09671() {
        }
    ...
    class C09682 implements PreloadSizeProvider<T> {
        C09682() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C09671();
        this.preloadDimensionProvider = new C09682();
