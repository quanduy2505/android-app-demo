...
class LZWEncoder {
    ...
    LZWEncoder(int width, int height, byte[] pixels, int color_depth) {
        this.maxbits = BITS;
        this.maxmaxcode = ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
        ...
        this.cur_accum = 0;
        this.cur_bits = 0;
        this.masks = new int[]{0, 1, 3, 7, 15, 31, 63, TransportMediator.KEYCODE_MEDIA_PAUSE, MotionEventCompat.ACTION_MASK, 511, 1023, 2047, 4095, 8191, 16383, 32767, SupportMenu.USER_MASK};
        this.accum = new byte[AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY];
        this.imgW = width;
        this.imgH = height;
        this.pixAry = pixels;
    ...
    void compress(int init_bits, OutputStream outs) throws IOException {
        ...
        int ent = nextPixel();
        int hshift = 0;
        for (fcode = this.hsize; fcode < NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST; fcode *= 2) {
            hshift++;
        }
        hshift = 8 - hshift;
