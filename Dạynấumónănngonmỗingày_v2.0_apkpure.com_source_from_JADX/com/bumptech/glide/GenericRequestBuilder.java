...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    class C03391 implements Runnable {
        ...
        C03391(RequestFutureTarget requestFutureTarget) {
            this.val$target = requestFutureTarget;
        }

        public void run() {
            if (!this.val$target.isCancelled()) {
                GenericRequestBuilder.this.into(this.val$target);
            }
        }
    }

    /* renamed from: com.bumptech.glide.GenericRequestBuilder.2 */
    static /* synthetic */ class C03402 {
    ...
    public Target<TranscodeType> into(ImageView view) {
        ...
        if (!(this.isTransformationSet || view.getScaleType() == null)) {
            switch (C03402.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
    ...
    public FutureTarget<TranscodeType> into(int width, int height) {
        RequestFutureTarget<ModelType, TranscodeType> target = new RequestFutureTarget(this.glide.getMainHandler(), width, height);
        this.glide.getMainHandler().post(new C03391(target));
        return target;
    }
