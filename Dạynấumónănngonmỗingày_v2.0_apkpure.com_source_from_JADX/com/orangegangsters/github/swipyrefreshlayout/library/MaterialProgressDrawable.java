...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /* renamed from: com.orangegangsters.github.swipyrefreshlayout.library.MaterialProgressDrawable.1 */
    class C07641 extends Animation {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            float targetRotation = (float) (Math.floor((double) (this.val$ring.getStartingRotation() / MaterialProgressDrawable.MAX_PROGRESS_ARC)) + 1.0d);
            this.val$ring.setStartTrim(this.val$ring.getStartingStartTrim() + ((this.val$ring.getStartingEndTrim() - this.val$ring.getStartingStartTrim()) * interpolatedTime));
            this.val$ring.setRotation(this.val$ring.getStartingRotation() + ((targetRotation - this.val$ring.getStartingRotation()) * interpolatedTime));
            this.val$ring.setArrowScale(1.0f - interpolatedTime);
        }
    }

    /* renamed from: com.orangegangsters.github.swipyrefreshlayout.library.MaterialProgressDrawable.2 */
    class C07652 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
        ...
        public void onAnimationEnd(Animation animation) {
            if (!MaterialProgressDrawable.this.stopped) {
    ...
    /* renamed from: com.orangegangsters.github.swipyrefreshlayout.library.MaterialProgressDrawable.3 */
    class C07663 extends Animation {
        final /* synthetic */ Ring val$ring;
    ...
    /* renamed from: com.orangegangsters.github.swipyrefreshlayout.library.MaterialProgressDrawable.4 */
    class C07674 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    /* renamed from: com.orangegangsters.github.swipyrefreshlayout.library.MaterialProgressDrawable.5 */
    class C07685 implements Callback {
        C07685() {
        }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation finishRingAnimation = new C07641(ring);
        finishRingAnimation.setInterpolator(EASE_INTERPOLATOR);
        finishRingAnimation.setDuration(666);
        finishRingAnimation.setAnimationListener(new C07652(ring));
        Animation animation = new C07663(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setDuration(1333);
        animation.setAnimationListener(new C07674(ring));
