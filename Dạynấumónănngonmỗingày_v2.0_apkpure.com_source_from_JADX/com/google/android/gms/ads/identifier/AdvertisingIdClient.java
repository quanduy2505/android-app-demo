...
public class AdvertisingIdClient {
    ...
    class C05991 extends Thread {
        final /* synthetic */ String zzsk;

        C05991(AdvertisingIdClient advertisingIdClient, String str) {
            this.zzsk = str;
        }
    ...
    private void zza(Info info, boolean z, float f, Throwable th) {
        if (Math.random() <= ((double) f)) {
            new C05991(this, zza(info, z, th).toString()).start();
        }
    }
    ...
    Uri zza(Info info, boolean z, Throwable th) {
        ...
        if (th != null) {
            bundle.putString(NativeProtocol.BRIDGE_ARG_ERROR_BUNDLE, th.getClass().getName());
        }
