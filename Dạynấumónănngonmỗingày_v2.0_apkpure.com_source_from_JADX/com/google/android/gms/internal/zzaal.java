...
public final class zzaal extends GoogleApiClient implements com.google.android.gms.internal.zzaau.zza {
    ...
    private zzaau zzaAk;
    final Queue<com.google.android.gms.internal.zzzv.zza<?, ?>> zzaAl;
    ...
    Set<Scope> zzaAs;
    private final zzaba zzaAt;
    private final ArrayList<zzzy> zzaAu;
    private Integer zzaAv;
    Set<zzabp> zzaAw;
    final zzabq zzaAx;
    private final com.google.android.gms.common.internal.zzm.zza zzaAy;
    ...
    class C11581 implements com.google.android.gms.common.internal.zzm.zza {
        final /* synthetic */ zzaal zzaAz;

        C11581(zzaal com_google_android_gms_internal_zzaal) {
            this.zzaAz = com_google_android_gms_internal_zzaal;
        }
    ...
    class C11592 implements ConnectionCallbacks {
        final /* synthetic */ AtomicReference zzaAA;
        final /* synthetic */ zzabl zzaAB;
        final /* synthetic */ zzaal zzaAz;

        C11592(zzaal com_google_android_gms_internal_zzaal, AtomicReference atomicReference, zzabl com_google_android_gms_internal_zzabl) {
            this.zzaAz = com_google_android_gms_internal_zzaal;
            this.zzaAA = atomicReference;
            this.zzaAB = com_google_android_gms_internal_zzabl;
        }

        public void onConnected(Bundle bundle) {
            this.zzaAz.zza((GoogleApiClient) this.zzaAA.get(), this.zzaAB, true);
        }
    ...
    /* renamed from: com.google.android.gms.internal.zzaal.3 */
    class C11603 implements OnConnectionFailedListener {
        final /* synthetic */ zzabl zzaAB;

        C11603(zzaal com_google_android_gms_internal_zzaal, zzabl com_google_android_gms_internal_zzabl) {
            this.zzaAB = com_google_android_gms_internal_zzabl;
        }
    ...
    /* renamed from: com.google.android.gms.internal.zzaal.4 */
    class C11614 implements ResultCallback<Status> {
        final /* synthetic */ zzabl zzaAB;
        final /* synthetic */ boolean zzaAC;
        final /* synthetic */ zzaal zzaAz;
        final /* synthetic */ GoogleApiClient zzaob;

        C11614(zzaal com_google_android_gms_internal_zzaal, zzabl com_google_android_gms_internal_zzabl, boolean z, GoogleApiClient googleApiClient) {
            this.zzaAz = com_google_android_gms_internal_zzaal;
            this.zzaAB = com_google_android_gms_internal_zzabl;
            this.zzaAC = z;
    ...
    public zzaal(Context context, Lock lock, Looper looper, zzg com_google_android_gms_common_internal_zzg, GoogleApiAvailability googleApiAvailability, com.google.android.gms.common.api.Api.zza<? extends zzaxn, zzaxo> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzaxn__com_google_android_gms_internal_zzaxo, Map<Api<?>, Integer> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<zzc<?>, zze> map2, int i, int i2, ArrayList<zzzy> arrayList, boolean z) {
        this.zzaAk = null;
        this.zzaAl = new LinkedList();
        this.zzaAn = 120000;
        this.zzaAo = 5000;
        this.zzaAs = new HashSet();
        this.zzaAt = new zzaba();
        this.zzaAv = null;
        this.zzaAw = null;
        this.zzaAy = new C11581(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzabl com_google_android_gms_internal_zzabl, boolean z) {
        zzabx.zzaFp.zzg(googleApiClient).setResultCallback(new C11614(this, com_google_android_gms_internal_zzabl, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        PendingResult com_google_android_gms_internal_zzabl = new zzabl((GoogleApiClient) this);
        if (this.zzaAr.containsKey(zzabx.zzahc)) {
            zza(this, com_google_android_gms_internal_zzabl, false);
        } else {
            AtomicReference atomicReference = new AtomicReference();
            GoogleApiClient build = new Builder(this.mContext).addApi(zzabx.API).addConnectionCallbacks(new C11592(this, atomicReference, com_google_android_gms_internal_zzabl)).addOnConnectionFailedListener(new C11603(this, com_google_android_gms_internal_zzabl)).setHandler(this.zzaAp).build();
    ...
    String zzvN() {
        ...
        dump(BuildConfig.VERSION_NAME, null, new PrintWriter(stringWriter), null);
