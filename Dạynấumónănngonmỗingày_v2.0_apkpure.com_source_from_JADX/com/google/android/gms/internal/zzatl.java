...
class zzatl extends zzats {
    static final Pair<String, Long> zzbse;
    private SharedPreferences zzafC;
    public final zzc zzbsf;
    public final zzb zzbsg;
    public final zzb zzbsh;
    public final zzb zzbsi;
    public final zzb zzbsj;
    public final zzb zzbsk;
    private String zzbsl;
    private boolean zzbsm;
    private long zzbsn;
    private SecureRandom zzbso;
    public final zzb zzbsp;
    public final zzb zzbsq;
    public final zza zzbsr;
    public final zzb zzbss;
    public final zzb zzbst;
    ...
    static {
        zzbse = new Pair(BuildConfig.VERSION_NAME, Long.valueOf(0));
    }

    zzatl(zzatp com_google_android_gms_internal_zzatp) {
        super(com_google_android_gms_internal_zzatp);
        this.zzbsf = new zzc("health_monitor", zzJv().zzoZ(), null);
        this.zzbsg = new zzb(this, "last_upload", 0);
        this.zzbsh = new zzb(this, "last_upload_attempt", 0);
        this.zzbsi = new zzb(this, "backoff", 0);
        this.zzbsj = new zzb(this, "last_delete_stale", 0);
        this.zzbsp = new zzb(this, "time_before_start", 10000);
        this.zzbsq = new zzb(this, "session_timeout", 1800000);
        this.zzbsr = new zza(this, "start_new_session", true);
        this.zzbss = new zzb(this, "last_pause_time", 0);
        this.zzbst = new zzb(this, "time_active", 0);
        this.zzbsk = new zzb(this, "midnight_offset", 0);
    }
    ...
    long zzLk() {
        ...
        j = (long) (zzLi().nextInt(UrlImageViewHelper.CACHE_DURATION_ONE_DAY) + 1);
        this.zzbsk.set(j);
        return j;
    }
    ...
    Pair<String, Boolean> zzfK(String str) {
        ...
        try {
            ...
            if (this.zzbsl == null) {
                this.zzbsl = BuildConfig.VERSION_NAME;
            }
