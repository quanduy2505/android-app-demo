...
public final class zzbum {
    ...
    public static class zza extends IOException {
        zza(int i, int i2) {
            super(new StringBuilder(C0801R.styleable.AppCompatTheme_ratingBarStyle).append("CodedOutputStream was writing to a flat byte array and ran out of space (pos ").append(i).append(" limit ").append(i2).append(").").toString());
        }
    }
    ...
    public void zzbd(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzqr((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            j >>>= 7;
        }
        zzqr((int) j);
    }
    ...
    public void zzqt(int i) throws IOException {
        while ((i & -128) != 0) {
            zzqr((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i >>>= 7;
        }
        zzqr(i);
    }
