            ...
            try {
                ...
                try {
                    ...
                    if (this.zzbrY != null) {
                        ...
                        zzc.addRequestProperty(HTTP.CONTENT_ENCODING, "gzip");
                        ...
                        try {
                            ...
                            this.zzbsb.zzJs().zzm(new zzb(this.zzbrZ, i, e, null, map, null));
                        } catch (Throwable th2) {
                            th = th2;
                            map2 = null;
                            if (outputStream != null) {
                            ...
                            this.zzbsb.zzJs().zzm(new zzb(this.zzbrZ, i2, null, null, map2, null));
                            throw th;
                        }
                    }
                ...
                try {
                    ...
                    this.zzbsb.zzJs().zzm(new zzb(this.zzbrZ, i2, null, zza, map2, null));
