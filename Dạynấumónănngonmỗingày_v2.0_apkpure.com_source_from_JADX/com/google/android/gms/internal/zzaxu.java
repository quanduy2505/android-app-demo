...
public interface zzaxu extends IInterface {

    public static abstract class zza extends Binder implements zzaxu {

        private static class zza implements zzaxu {
            ...
            public void zza(ConnectionResult connectionResult, zzaxp com_google_android_gms_internal_zzaxp) throws RemoteException {
            ...
            public void zzb(zzayb com_google_android_gms_internal_zzayb) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.signin.internal.ISignInCallbacks");
        ...
        public static zzaxu zzeX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaxu)) ? new zza(iBinder) : (zzaxu) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case ConnectionResult.SERVICE_DISABLED /*3*/:
                    ...
                    zza(parcel.readInt() != 0 ? (ConnectionResult) ConnectionResult.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (zzaxp) zzaxp.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case ConnectionResult.SIGN_IN_REQUIRED /*4*/:
                    parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInCallbacks");
                    zzbI(parcel.readInt() != 0 ? (Status) Status.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                ...
                case ConnectionResult.INTERNAL_ERROR /*8*/:
                    parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInCallbacks");
                    zzb(parcel.readInt() != 0 ? (zzayb) zzayb.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(ConnectionResult connectionResult, zzaxp com_google_android_gms_internal_zzaxp) throws RemoteException;

    void zza(Status status, GoogleSignInAccount googleSignInAccount) throws RemoteException;

    void zzb(zzayb com_google_android_gms_internal_zzayb) throws RemoteException;

    void zzbI(Status status) throws RemoteException;
