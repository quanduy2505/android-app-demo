...
public class zzbti implements Closeable {
    ...
    static class C12141 extends zzbsn {
        C12141() {
        }
        ...
        public void zzi(zzbti com_google_android_gms_internal_zzbti) throws IOException {
            ...
            if (zzG == 13) {
                ...
                throw new IllegalStateException(new StringBuilder((String.valueOf(valueOf).length() + 70) + String.valueOf(path).length()).append("Expected a name but was ").append(valueOf).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(" at line ").append(zzI).append(" column ").append(zzJ).append(" path ").append(path).toString());
            }
        }
    }
        ...
        if (i == 1) {
            ...
            switch (zzbh(true)) {
                case C0801R.styleable.AppCompatTheme_dialogPreferredPadding /*44*/:
                    break;
                case C0801R.styleable.AppCompatTheme_toolbarStyle /*59*/:
                    zzaci();
                    break;
            ...
            switch (zzbh(true)) {
                case C0801R.styleable.AppCompatTheme_activityChooserViewStyle /*58*/:
                    break;
    ...
    public double nextDouble() throws IOException {
        ...
        throw new zzbtl(new StringBuilder(String.valueOf(path2).length() + HttpStatus.SC_PROCESSING).append("JSON forbids NaN and infinities: ").append(parseDouble).append(" at line ").append(columnNumber).append(" column ").append(columnNumber2).append(" path ").append(path2).toString());
    }
