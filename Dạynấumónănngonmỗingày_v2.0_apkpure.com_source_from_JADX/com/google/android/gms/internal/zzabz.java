...
public final class zzabz implements zzaby {
    ...
    class C16211 extends zza {
        C16211(zzabz com_google_android_gms_internal_zzabz, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzg(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C16211(this, googleApiClient));
    }
}
