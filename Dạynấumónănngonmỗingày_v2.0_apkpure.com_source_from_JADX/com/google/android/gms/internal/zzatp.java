...
public class zzatp {
    ...
    class C06481 implements Runnable {
        ...
        C06481(zzatp com_google_android_gms_internal_zzatp) {
    ...
    /* renamed from: com.google.android.gms.internal.zzatp.2 */
    class C06492 implements Callable<String> {
        final /* synthetic */ String zzbky;
        final /* synthetic */ zzatp zzbtH;

        C06492(zzatp com_google_android_gms_internal_zzatp, String str) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
            this.zzbky = str;
        }
        ...
        public String zzou() throws Exception {
            zzasp zzfy = this.zzbtH.zzJo().zzfy(this.zzbky);
            return zzfy == null ? null : zzfy.getAppInstanceId();
        }
    }

    /* renamed from: com.google.android.gms.internal.zzatp.3 */
    class C06503 implements Callable<String> {
        final /* synthetic */ String zzbky;
        final /* synthetic */ zzatp zzbtH;

        C06503(zzatp com_google_android_gms_internal_zzatp, String str) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
            this.zzbky = str;
        }
    ...
    class C11684 implements zza {
        final /* synthetic */ zzatp zzbtH;

        C11684(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
    ...
    class C11695 implements zza {
        final /* synthetic */ zzatp zzbtH;

        C11695(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
    ...
    zzatp(zzatt com_google_android_gms_internal_zzatt) {
        ...
        this.zzbtg.zzm(new C06481(this));
    }
    ...
    public java.lang.String getGmpAppIdOnPackageSide(java.lang.String r5) {
        /*
        r4 = this;
        r4.zzJd();
        r0 = r4.zzJs();
        r1 = new com.google.android.gms.internal.zzatp$3;
        r1.<init>(r4, r5);
        r0 = r0.zze(r1);
        r2 = 30000; // 0x7530 float:4.2039E-41 double:1.4822E-319;
        r1 = java.util.concurrent.TimeUnit.MILLISECONDS;	 Catch:{ TimeoutException -> 0x0031, InterruptedException -> 0x001b, ExecutionException -> 0x002f }
        r0 = r0.get(r2, r1);	 Catch:{ TimeoutException -> 0x0031, InterruptedException -> 0x001b, ExecutionException -> 0x002f }
        r0 = (java.lang.String) r0;	 Catch:{ TimeoutException -> 0x0031, InterruptedException -> 0x001b, ExecutionException -> 0x002f }
    L_0x001a:
        return r0;
    L_0x001b:
        r0 = move-exception;
    L_0x001c:
        r1 = r4.zzJt();
        r1 = r1.zzLa();
        r2 = "Failed to get gmp app id. appId";
        r3 = com.google.android.gms.internal.zzati.zzfI(r5);
        r1.zze(r2, r3, r0);
        r0 = 0;
        goto L_0x001a;
    L_0x002f:
    ...
    L_0x0031:
        ...
        goto L_0x001c;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzatp.getGmpAppIdOnPackageSide(java.lang.String):java.lang.String");
    }
        ...
        if (zzLn == null) {
            ...
            if (!zzn.isEmpty()) {
                ...
                try {
                    ...
                    zzLy().zza(zzKG, url, zza, null, new C11684(this));
    ...
    void zzb(zzasp com_google_android_gms_internal_zzasp) {
        ...
        try {
            ...
            if (!(zzfO == null || TextUtils.isEmpty(zzfP))) {
                map = new ArrayMap();
                map.put(HttpHeaders.IF_MODIFIED_SINCE, zzfP);
            }
            zzLy().zza(com_google_android_gms_internal_zzasp.zzjI(), url, map, new C11695(this));
        } catch (MalformedURLException e) {
    ...
    void zzb(zzasq com_google_android_gms_internal_zzasq, long j) {
        ...
        if (getContext().getPackageManager() == null) {
            ...
            if (applicationInfo != null) {
                ...
                if ((applicationInfo.flags & TransportMediator.FLAG_KEY_MEDIA_NEXT) != 0) {
    ...
    void zzb(String str, int i, Throwable th, byte[] bArr, Map<String, List<String>> map) {
        ...
        try {
            zzasp zzfy = zzJo().zzfy(str);
            int i3 = ((i == HttpStatus.SC_OK || i == HttpStatus.SC_NO_CONTENT || i == HttpStatus.SC_NOT_MODIFIED) && th == null) ? 1 : 0;
            if (zzfy == null) {
                zzJt().zzLc().zzj("App does not exist in onConfigFetched. appId", zzati.zzfI(str));
            } else if (i3 != 0 || i == HttpStatus.SC_NOT_FOUND) {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.lang.String zzfR(java.lang.String r5) {
        /*
        r4 = this;
        r0 = r4.zzJs();
        r1 = new com.google.android.gms.internal.zzatp$2;
        r1.<init>(r4, r5);
        r0 = r0.zzd(r1);
        r2 = 30000; // 0x7530 float:4.2039E-41 double:1.4822E-319;
    ...
    L_0x002e:
        ...
        goto L_0x0019;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzatp.zzfR(java.lang.String):java.lang.String");
    }
