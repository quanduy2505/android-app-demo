...
public final class zzbsm implements zzbse, Cloneable {
    ...
    class C11911 extends zzbsd<T> {
        ...
        C11911(zzbsm com_google_android_gms_internal_zzbsm, boolean z, boolean z2, zzbrl com_google_android_gms_internal_zzbrl, zzbth com_google_android_gms_internal_zzbth) {
    ...
    public <T> zzbsd<T> zza(zzbrl com_google_android_gms_internal_zzbrl, zzbth<T> com_google_android_gms_internal_zzbth_T) {
        ...
        return (zza || zza2) ? new C11911(this, zza2, zza, com_google_android_gms_internal_zzbrl, com_google_android_gms_internal_zzbth_T) : null;
    }
