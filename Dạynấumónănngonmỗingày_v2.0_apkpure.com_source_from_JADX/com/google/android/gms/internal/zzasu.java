...
class zzasu extends zzats {
    private static final Map<String, String> zzbqp;
    ...
    zzasu(zzatp com_google_android_gms_internal_zzatp) {
        ...
        this.zzbqu = new zzatz(zznq());
        this.zzbqt = new zzc(this, getContext(), zznV());
    }
    ...
    private boolean zza(String str, int i, com.google.android.gms.internal.zzauf.zzb com_google_android_gms_internal_zzauf_zzb) {
        ...
        try {
            ...
            contentValues.put(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, str);
            contentValues.put("audience_id", Integer.valueOf(i));
            contentValues.put("filter_id", com_google_android_gms_internal_zzauf_zzb.zzbvl);
            contentValues.put(MeasurementEvent.MEASUREMENT_EVENT_NAME_KEY, com_google_android_gms_internal_zzauf_zzb.zzbvm);
    ...
    protected long zzU(String str, String str2) {
        ...
        try {
            ...
            try {
                ...
                contentValues2.put(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, str);
    ...
    public long zza(zze com_google_android_gms_internal_zzauh_zze) throws IOException {
        ...
        try {
            ...
            ContentValues contentValues = new ContentValues();
            contentValues.put(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, com_google_android_gms_internal_zzauh_zze.zzaR);
    ...
    public void zza(zzasp com_google_android_gms_internal_zzasp) {
        ...
        zznA();
        ContentValues contentValues = new ContentValues();
        contentValues.put(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, com_google_android_gms_internal_zzasp.zzjI());
    ...
    public void zza(zzasx com_google_android_gms_internal_zzasx, long j, boolean z) {
        ...
        try {
            ...
            ContentValues contentValues = new ContentValues();
            contentValues.put(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, com_google_android_gms_internal_zzasx.zzVQ);
            contentValues.put(ShareConstants.WEB_DIALOG_PARAM_NAME, com_google_android_gms_internal_zzasx.mName);
    ...
    public void zza(zzasy com_google_android_gms_internal_zzasy) {
        ...
        zznA();
        ContentValues contentValues = new ContentValues();
        contentValues.put(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, com_google_android_gms_internal_zzasy.zzVQ);
        contentValues.put(ShareConstants.WEB_DIALOG_PARAM_NAME, com_google_android_gms_internal_zzasy.mName);
    ...
    public void zza(String str, long j, long j2, zzb com_google_android_gms_internal_zzasu_zzb) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            str2 = j2 != -1 ? "rowid <= ? and " : BuildConfig.VERSION_NAME;
        ...
        str2 = j2 != -1 ? " and rowid <= ?" : BuildConfig.VERSION_NAME;
        ...
        try {
            ...
            if (cursor2.moveToFirst()) {
                ...
                try {
                    ...
                    cursor = writableDatabase.query("raw_events", new String[]{"rowid", ShareConstants.WEB_DIALOG_PARAM_NAME, "timestamp", ShareConstants.WEB_DIALOG_PARAM_DATA}, str4, strArr2, null, null, "rowid", null);
                    if (cursor.moveToFirst()) {
                        do {
                            try {
    ...
    public boolean zza(zzaud com_google_android_gms_internal_zzaud) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, com_google_android_gms_internal_zzaud.zzVQ);
        contentValues.put(ShareConstants.WEB_DIALOG_PARAM_NAME, com_google_android_gms_internal_zzaud.mName);
    ...
    public List<zzaud> zzfx(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{ShareConstants.WEB_DIALOG_PARAM_NAME, "set_timestamp", Param.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzJv().zzKf()));
            try {
                if (query.moveToFirst()) {
                    do {
    ...
    public java.util.List<android.util.Pair<com.google.android.gms.internal.zzauh.zze, java.lang.Long>> zzn(java.lang.String r12, int r13, int r14) {
        /*
        r11 = this;
        r10 = 0;
        r1 = 1;
    ...
    L_0x0011:
        com.google.android.gms.common.internal.zzac.zzas(r1);
        com.google.android.gms.common.internal.zzac.zzdv(r12);
        r0 = r11.getWritableDatabase();	 Catch:{ SQLiteException -> 0x00ef, all -> 0x00e2 }
        r1 = "queue";
        r2 = 2;
        ...
        r0 = r2.moveToFirst();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        if (r0 != 0) goto L_0x0052;
    L_0x0044:
        r0 = java.util.Collections.emptyList();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
    ...
    L_0x0050:
        ...
        goto L_0x0011;
    L_0x0052:
        r0 = new java.util.ArrayList;	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r0.<init>();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r3 = r9;
    L_0x0058:
        r1 = 0;
        r4 = r2.getLong(r1);	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r1 = 1;
        r1 = r2.getBlob(r1);	 Catch:{ IOException -> 0x007a }
        r6 = r11.zzJp();	 Catch:{ IOException -> 0x007a }
        r1 = r6.zzx(r1);	 Catch:{ IOException -> 0x007a }
        r6 = r0.isEmpty();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        if (r6 != 0) goto L_0x0097;
    L_0x0070:
        r6 = r1.length;	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r6 = r6 + r3;
    ...
    L_0x007a:
        r1 = move-exception;
        r4 = r11.zzJt();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r4 = r4.zzLa();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r5 = "Failed to unzip queued bundle. appId";
        r6 = com.google.android.gms.internal.zzati.zzfI(r12);	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r4.zze(r5, r6, r1);	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r1 = r3;
    L_0x008d:
        r3 = r2.moveToNext();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
    ...
    L_0x0095:
        ...
        goto L_0x0058;
    L_0x0097:
        r6 = com.google.android.gms.internal.zzbul.zzad(r1);	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r7 = new com.google.android.gms.internal.zzauh$zze;	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r7.<init>();	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r7.zzb(r6);	 Catch:{ IOException -> 0x00ce }
        r1 = r1.length;	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r1 = r1 + r3;
        r3 = java.lang.Long.valueOf(r4);	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
        r3 = android.util.Pair.create(r7, r3);	 Catch:{ SQLiteException -> 0x00b1, all -> 0x00ea }
    ...
    L_0x00b1:
        ...
        r1 = r2;
    L_0x00b3:
        r2 = r11.zzJt();	 Catch:{ all -> 0x00ec }
        r2 = r2.zzLa();	 Catch:{ all -> 0x00ec }
        r3 = "Error querying bundles. appId";
        r4 = com.google.android.gms.internal.zzati.zzfI(r12);	 Catch:{ all -> 0x00ec }
    ...
    L_0x00ef:
        ...
        goto L_0x00b3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzasu.zzn(java.lang.String, int, int):java.util.List<android.util.Pair<com.google.android.gms.internal.zzauh$zze, java.lang.Long>>");
    }
