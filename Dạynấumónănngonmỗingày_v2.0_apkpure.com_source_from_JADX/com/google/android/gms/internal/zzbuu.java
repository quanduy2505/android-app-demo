...
public final class zzbuu {
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        if (obj != null) {
            if (obj instanceof zzbut) {
                ...
                if (str != null) {
                    stringBuffer2.append(stringBuffer).append(zzkd(str)).append(" <\n");
                    stringBuffer.append("  ");
                }
            ...
            if (obj instanceof String) {
                stringBuffer2.append("\"").append(zzcE((String) obj)).append("\"");
    ...
    private static String zzcE(String str) {
        if (!str.startsWith(HttpHost.DEFAULT_SCHEME_NAME) && str.length() > HttpStatus.SC_OK) {
            str = String.valueOf(str.substring(0, HttpStatus.SC_OK)).concat("[...]");
        }
        return zzdC(str);
    }

    private static String zzdC(String str) {
    ...
    private static String zzkd(String str) {
        StringBuffer stringBuffer = new StringBuffer();
