...
public class zzt implements zzf {
    ...
    static {
        DEBUG = zzs.DEBUG;
        zzam = 3000;
        zzan = ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
    }
    ...
    private void zza(Map<String, String> map, zza com_google_android_gms_internal_zzb_zza) {
        if (com_google_android_gms_internal_zzb_zza != null) {
            if (com_google_android_gms_internal_zzb_zza.zza != null) {
                map.put(HttpHeaders.IF_NONE_MATCH, com_google_android_gms_internal_zzb_zza.zza);
            }
            if (com_google_android_gms_internal_zzb_zza.zzc > 0) {
                map.put(HttpHeaders.IF_MODIFIED_SINCE, DateUtils.formatDate(new Date(com_google_android_gms_internal_zzb_zza.zzc)));
            }
        }
    }
    ...
    private byte[] zza(HttpEntity httpEntity) throws IOException, zzp {
        ...
        try {
            ...
            bArr = this.zzap.zzb(AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT);
            while (true) {
