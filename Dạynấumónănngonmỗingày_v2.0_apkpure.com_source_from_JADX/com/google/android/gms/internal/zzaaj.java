...
public class zzaaj implements zzaam {
    ...
    private final Set<com.google.android.gms.common.api.Api.zzc> zzazR;
    private zzaxn zzazS;
    private int zzazT;
    ...
    private ArrayList<Future<?>> zzazZ;
    ...
    class C06271 implements Runnable {
        ...
        C06271(zzaaj com_google_android_gms_internal_zzaaj) {
    ...
    private class zzb extends zzf {
        ...
        /* renamed from: com.google.android.gms.internal.zzaaj.zzb.1 */
        class C11551 extends zza {
            final /* synthetic */ ConnectionResult zzaAd;
            final /* synthetic */ zzb zzaAe;

            C11551(zzb com_google_android_gms_internal_zzaaj_zzb, zzaam com_google_android_gms_internal_zzaam, ConnectionResult connectionResult) {
                this.zzaAe = com_google_android_gms_internal_zzaaj_zzb;
                this.zzaAd = connectionResult;
                super(com_google_android_gms_internal_zzaam);
            }

            public void zzvA() {
                this.zzaAe.zzaAa.zzf(this.zzaAd);
            }
        }

        /* renamed from: com.google.android.gms.internal.zzaaj.zzb.2 */
        class C11562 extends zza {
            final /* synthetic */ com.google.android.gms.common.internal.zzf.zzf zzaAf;

            C11562(zzb com_google_android_gms_internal_zzaaj_zzb, zzaam com_google_android_gms_internal_zzaam, com.google.android.gms.common.internal.zzf.zzf com_google_android_gms_common_internal_zzf_zzf) {
                this.zzaAf = com_google_android_gms_common_internal_zzf_zzf;
                super(com_google_android_gms_internal_zzaam);
            }
        ...
        public void zzvA() {
            ...
            if (i3 == 0 || (r0 == 0 && i4 == 0)) {
                ...
                for (com.google.android.gms.common.api.Api.zze com_google_android_gms_common_api_Api_zze2 : this.zzaAc.keySet()) {
                    com.google.android.gms.common.internal.zzf.zzf com_google_android_gms_common_internal_zzf_zzf = (com.google.android.gms.common.internal.zzf.zzf) this.zzaAc.get(com_google_android_gms_common_api_Api_zze2);
                    if (!com_google_android_gms_common_api_Api_zze2.zzuI() || i3 == 0) {
                        ...
                        this.zzaAa.zzazK.zza(new C11562(this, this.zzaAa, com_google_android_gms_common_internal_zzf_zzf));
                    }
                }
                return;
            }
            this.zzaAa.zzazK.zza(new C11551(this, this.zzaAa, new ConnectionResult(i3, null)));
        }
    }
    ...
    private static class zzd extends zzaxr {
        ...
        /* renamed from: com.google.android.gms.internal.zzaaj.zzd.1 */
        class C11571 extends zza {
            final /* synthetic */ zzaaj zzaAh;
            final /* synthetic */ zzayb zzaAi;

            C11571(zzd com_google_android_gms_internal_zzaaj_zzd, zzaam com_google_android_gms_internal_zzaam, zzaaj com_google_android_gms_internal_zzaaj, zzayb com_google_android_gms_internal_zzayb) {
                this.zzaAh = com_google_android_gms_internal_zzaaj;
                this.zzaAi = com_google_android_gms_internal_zzayb;
                super(com_google_android_gms_internal_zzaam);
            }

            public void zzvA() {
                this.zzaAh.zza(this.zzaAi);
            }
        }
        ...
        @BinderThread
        public void zzb(zzayb com_google_android_gms_internal_zzayb) {
            zzaaj com_google_android_gms_internal_zzaaj = (zzaaj) this.zzaAb.get();
            if (com_google_android_gms_internal_zzaaj != null) {
                com_google_android_gms_internal_zzaaj.zzazK.zza(new C11571(this, com_google_android_gms_internal_zzaaj, com_google_android_gms_internal_zzaaj, com_google_android_gms_internal_zzayb));
            }
        }
    }
    ...
    public zzaaj(zzaan com_google_android_gms_internal_zzaan, zzg com_google_android_gms_common_internal_zzg, Map<Api<?>, Integer> map, com.google.android.gms.common.zzc com_google_android_gms_common_zzc, com.google.android.gms.common.api.Api.zza<? extends zzaxn, zzaxo> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzaxn__com_google_android_gms_internal_zzaxo, Lock lock, Context context) {
        this.zzazO = 0;
        this.zzazQ = new Bundle();
        this.zzazR = new HashSet();
        this.zzazZ = new ArrayList();
    ...
    private void zzvE() {
        this.zzazK.zzvP();
        zzaao.zzvR().execute(new C06271(this));
        if (this.zzazS != null) {
            if (this.zzazX) {
