...
public class zzzt extends zzzw {
    private final SparseArray<zza> zzayx;
    ...
    public void zza(int i, GoogleApiClient googleApiClient, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        Log.d("AutoManageHelper", "starting AutoManage for client " + i + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.mStarted + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.zzayG);
