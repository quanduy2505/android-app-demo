...
public class zzc extends Thread {
    ...
    class C06931 implements Runnable {
        ...
        C06931(zzc com_google_android_gms_internal_zzc, zzk com_google_android_gms_internal_zzk) {
            ...
            try {
                ...
                if (zza == null) {
                    ...
                    if (zza.zzb()) {
                        ...
                        com_google_android_gms_internal_zzk.zza(zza);
                        zza2.zzag = true;
                        this.zzj.zza(com_google_android_gms_internal_zzk, zza2, new C06931(this, com_google_android_gms_internal_zzk));
                    } else {
