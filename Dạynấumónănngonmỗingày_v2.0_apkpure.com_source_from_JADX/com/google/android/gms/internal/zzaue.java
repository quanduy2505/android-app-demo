...
public class zzaue extends zzats {
    ...
    public static String zza(zzb com_google_android_gms_internal_zzauf_zzb) {
        ...
        zza(stringBuilder, 0, MeasurementEvent.MEASUREMENT_EVENT_NAME_KEY, com_google_android_gms_internal_zzauf_zzb.zzbvm);
    ...
    private static void zza(StringBuilder stringBuilder, int i, zzauh.zze com_google_android_gms_internal_zzauh_zze) {
        if (com_google_android_gms_internal_zzauh_zze != null) {
            ...
            zza(stringBuilder, i, ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, com_google_android_gms_internal_zzauh_zze.zzaR);
        ...
        if (com_google_android_gms_internal_zzauh_zzbArr != null) {
            ...
            for (zzauh.zzb com_google_android_gms_internal_zzauh_zzb : com_google_android_gms_internal_zzauh_zzbArr) {
                if (com_google_android_gms_internal_zzauh_zzb != null) {
                    ...
                    zza(stringBuilder, i2, ShareConstants.WEB_DIALOG_PARAM_NAME, com_google_android_gms_internal_zzauh_zzb.name);
        ...
        if (com_google_android_gms_internal_zzauh_zzcArr != null) {
            ...
            for (zzauh.zzc com_google_android_gms_internal_zzauh_zzc : com_google_android_gms_internal_zzauh_zzcArr) {
                if (com_google_android_gms_internal_zzauh_zzc != null) {
                    ...
                    zza(stringBuilder, i2, ShareConstants.WEB_DIALOG_PARAM_NAME, com_google_android_gms_internal_zzauh_zzc.name);
        ...
        if (com_google_android_gms_internal_zzauh_zzgArr != null) {
            ...
            for (zzg com_google_android_gms_internal_zzauh_zzg : com_google_android_gms_internal_zzauh_zzgArr) {
                if (com_google_android_gms_internal_zzauh_zzg != null) {
                    ...
                    zza(stringBuilder, i2, ShareConstants.WEB_DIALOG_PARAM_NAME, com_google_android_gms_internal_zzauh_zzg.name);
    ...
    public int zzfX(String str) {
        return !zzZ(NotificationCompatApi24.CATEGORY_EVENT, str) ? 2 : !zzc(NotificationCompatApi24.CATEGORY_EVENT, AppMeasurement.zza.zzbpx, str) ? 13 : zzc(NotificationCompatApi24.CATEGORY_EVENT, zzJv().zzJU(), str) ? 0 : 2;
    }

    public int zzfY(String str) {
        return !zzaa(NotificationCompatApi24.CATEGORY_EVENT, str) ? 2 : !zzc(NotificationCompatApi24.CATEGORY_EVENT, AppMeasurement.zza.zzbpx, str) ? 13 : zzc(NotificationCompatApi24.CATEGORY_EVENT, zzJv().zzJU(), str) ? 0 : 2;
    }
