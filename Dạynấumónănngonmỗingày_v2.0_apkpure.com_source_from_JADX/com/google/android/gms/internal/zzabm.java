...
public final class zzabm extends Fragment implements zzaax {
    private static WeakHashMap<FragmentActivity, WeakReference<zzabm>> zzaBt;
    private int zzJh;
    private Map<String, zzaaw> zzaBu;
    private Bundle zzaBv;

    /* renamed from: com.google.android.gms.internal.zzabm.1 */
    class C06341 implements Runnable {
        final /* synthetic */ String zzO;
        final /* synthetic */ zzabm zzaBL;
        final /* synthetic */ zzaaw zzaBw;

        C06341(zzabm com_google_android_gms_internal_zzabm, zzaaw com_google_android_gms_internal_zzaaw, String str) {
            this.zzaBL = com_google_android_gms_internal_zzabm;
            this.zzaBw = com_google_android_gms_internal_zzaaw;
            this.zzO = str;
        }

        public void run() {
            if (this.zzaBL.zzJh >= 1) {
                this.zzaBw.onCreate(this.zzaBL.zzaBv != null ? this.zzaBL.zzaBv.getBundle(this.zzO) : null);
            }
    ...
    static {
        zzaBt = new WeakHashMap();
    }

    public zzabm() {
        this.zzaBu = new ArrayMap();
        this.zzJh = 0;
    }
    ...
    private void zzb(String str, @NonNull zzaaw com_google_android_gms_internal_zzaaw) {
        if (this.zzJh > 0) {
            new Handler(Looper.getMainLooper()).post(new C06341(this, com_google_android_gms_internal_zzaaw, str));
        }
    }
