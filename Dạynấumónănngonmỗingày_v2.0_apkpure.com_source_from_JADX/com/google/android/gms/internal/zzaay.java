...
public final class zzaay extends Fragment implements zzaax {
    private static WeakHashMap<Activity, WeakReference<zzaay>> zzaBt;
    private int zzJh;
    ...
    class C06321 implements Runnable {
        ...
        C06321(zzaay com_google_android_gms_internal_zzaay, zzaaw com_google_android_gms_internal_zzaaw, String str) {
            this.zzaBx = com_google_android_gms_internal_zzaay;
        ...
        public void run() {
            if (this.zzaBx.zzJh >= 1) {
                this.zzaBw.onCreate(this.zzaBx.zzaBv != null ? this.zzaBx.zzaBv.getBundle(this.zzO) : null);
            }
    ...
    private void zzb(String str, @NonNull zzaaw com_google_android_gms_internal_zzaaw) {
        if (this.zzJh > 0) {
            new Handler(Looper.getMainLooper()).post(new C06321(this, com_google_android_gms_internal_zzaaw, str));
        }
    }
