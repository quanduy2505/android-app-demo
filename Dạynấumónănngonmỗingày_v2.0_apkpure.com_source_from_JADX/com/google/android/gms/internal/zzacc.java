...
public interface zzacc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzacc {
        ...
        private static class zza implements zzacc {
        ...
        public static zzacc zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzacc)) ? new zza(iBinder) : (zzacc) queryLocalInterface;
        }
