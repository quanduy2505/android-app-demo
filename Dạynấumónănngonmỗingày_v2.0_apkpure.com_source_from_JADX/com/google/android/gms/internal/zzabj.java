...
public class zzabj extends zzaxr implements ConnectionCallbacks, OnConnectionFailedListener {
    private static com.google.android.gms.common.api.Api.zza<? extends zzaxn, zzaxo> zzaBH;
    ...
    /* renamed from: com.google.android.gms.internal.zzabj.1 */
    class C06331 implements Runnable {
        final /* synthetic */ zzayb zzaAi;
        final /* synthetic */ zzabj zzaBK;

        C06331(zzabj com_google_android_gms_internal_zzabj, zzayb com_google_android_gms_internal_zzayb) {
            this.zzaBK = com_google_android_gms_internal_zzabj;
            this.zzaAi = com_google_android_gms_internal_zzayb;
        }

        public void run() {
            this.zzaBK.zzc(this.zzaAi);
        }
    }
    ...
    public void zzb(zzayb com_google_android_gms_internal_zzayb) {
        this.mHandler.post(new C06331(this, com_google_android_gms_internal_zzayb));
    }
