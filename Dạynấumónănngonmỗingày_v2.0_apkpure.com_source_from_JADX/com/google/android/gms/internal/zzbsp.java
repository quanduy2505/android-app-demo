...
public final class zzbsp<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> zzcnz;
    int modCount;
    int size;
    ...
    /* renamed from: com.google.android.gms.internal.zzbsp.1 */
    static class C06881 implements Comparator<Comparable> {
        C06881() {
        }
    ...
    class zza extends AbstractSet<Entry<K, V>> {
        ...
        /* renamed from: com.google.android.gms.internal.zzbsp.zza.1 */
        class C11921 extends zzc<Entry<K, V>> {
            final /* synthetic */ zza zzcnF;

            C11921(zza com_google_android_gms_internal_zzbsp_zza) {
                this.zzcnF = com_google_android_gms_internal_zzbsp_zza;
                super(null);
            }
    ...
    final class zzb extends AbstractSet<K> {
        ...
        /* renamed from: com.google.android.gms.internal.zzbsp.zzb.1 */
        class C11931 extends zzc<K> {
            final /* synthetic */ zzb zzcnG;

            C11931(zzb com_google_android_gms_internal_zzbsp_zzb) {
                this.zzcnG = com_google_android_gms_internal_zzbsp_zzb;
                super(null);
            }
    ...
    static {
        $assertionsDisabled = !zzbsp.class.desiredAssertionStatus();
        zzcnz = new C06881();
    }
