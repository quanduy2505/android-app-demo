...
public class zzatv extends zzats {
    ...
    private final CopyOnWriteArrayList<zzd> zzbuq;
    private boolean zzbur;
    private zzf zzbus;
    private String zzbut;

    /* renamed from: com.google.android.gms.internal.zzatv.1 */
    class C06671 implements Runnable {
        final /* synthetic */ boolean zzbuu;
        final /* synthetic */ zza zzbuv;
        final /* synthetic */ zzatv zzbuw;

        C06671(zzatv com_google_android_gms_internal_zzatv, boolean z, zza com_google_android_gms_internal_zzatv_zza) {
            this.zzbuw = com_google_android_gms_internal_zzatv;
            this.zzbuu = z;
            this.zzbuv = com_google_android_gms_internal_zzatv_zza;
        }

        public void run() {
            if (this.zzbuu && this.zzbuw.zzbul != null) {
                this.zzbuw.zza(this.zzbuw.zzbul);
            }
            this.zzbuw.zzbul = this.zzbuv;
            this.zzbuw.zzJl().zza(this.zzbuv);
        }
    }

    /* renamed from: com.google.android.gms.internal.zzatv.2 */
    class C06682 implements Runnable {
        final /* synthetic */ zzatv zzbuw;
        final /* synthetic */ zza zzbux;

        C06682(zzatv com_google_android_gms_internal_zzatv, zza com_google_android_gms_internal_zzatv_zza) {
            this.zzbuw = com_google_android_gms_internal_zzatv;
            this.zzbux = com_google_android_gms_internal_zzatv_zza;
        }

        public void run() {
            this.zzbuw.zza(this.zzbux);
    ...
    @MainThread
    private void zza(Activity activity, zza com_google_android_gms_internal_zzatv_zza, boolean z) {
        int i = 1;
        ...
        if (i != 0) {
            ...
            zzf com_google_android_gms_internal_zzatv_zza2 = new zza(com_google_android_gms_internal_zzatv_zza);
            this.zzbun = this.zzbum;
            this.zzbuo = zznq().elapsedRealtime();
            this.zzbum = com_google_android_gms_internal_zzatv_zza2;
            zzJs().zzm(new C06671(this, z, com_google_android_gms_internal_zzatv_zza2));
        }
    }
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (bundle2 != null) {
                ...
                zzv.zzbpB = bundle2.getLong(ShareConstants.WEB_DIALOG_PARAM_ID);
                zzv.zzbpz = bundle2.getString(ShareConstants.WEB_DIALOG_PARAM_NAME);
    ...
    public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (com_google_android_gms_internal_zzatv_zza != null) {
                ...
                bundle2.putLong(ShareConstants.WEB_DIALOG_PARAM_ID, com_google_android_gms_internal_zzatv_zza.zzbpB);
                bundle2.putString(ShareConstants.WEB_DIALOG_PARAM_NAME, com_google_android_gms_internal_zzatv_zza.zzbpz);
