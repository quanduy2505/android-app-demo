...
public class zzabq {
    public static final Status zzaBV;
    private static final zzzx<?>[] zzaBW;
    private final Map<zzc<?>, zze> zzaAr;
    final Set<zzzx<?>> zzaBX;
    private final zzb zzaBY;
    ...
    class C11621 implements zzb {
        ...
        C11621(zzabq com_google_android_gms_internal_zzabq) {
            this.zzaBZ = com_google_android_gms_internal_zzabq;
        }
    ...
    static {
        zzaBV = new Status(8, "The connection to Google Play services was lost");
        zzaBW = new zzzx[0];
    }

    public zzabq(Map<zzc<?>, zze> map) {
        this.zzaBX = Collections.synchronizedSet(Collections.newSetFromMap(new WeakHashMap()));
        this.zzaBY = new C11621(this);
        this.zzaAr = map;
    }
    ...
    private static void zza(zzzx<?> com_google_android_gms_internal_zzzx_, zzf com_google_android_gms_common_api_zzf, IBinder iBinder) {
        if (com_google_android_gms_internal_zzzx_.isReady()) {
            com_google_android_gms_internal_zzzx_.zza(new zza(com_google_android_gms_common_api_zzf, iBinder, null));
            ...
            zzb com_google_android_gms_internal_zzabq_zza = new zza(com_google_android_gms_common_api_zzf, iBinder, null);
