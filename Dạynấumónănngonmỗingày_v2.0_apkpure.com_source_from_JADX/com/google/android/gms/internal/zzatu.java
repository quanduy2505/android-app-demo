...
public class zzatu extends zzats {
    ...
    class C06601 implements Runnable {
        ...
        C06601(zzatu com_google_android_gms_internal_zzatu, boolean z) {
    ...
    class C06612 implements Runnable {
        ...
        C06612(zzatu com_google_android_gms_internal_zzatu, long j) {
            this.zzbua = com_google_android_gms_internal_zzatu;
            this.zzbub = j;
        }
    ...
    class C06623 implements Runnable {
        ...
        C06623(zzatu com_google_android_gms_internal_zzatu, long j) {
            this.zzbua = com_google_android_gms_internal_zzatu;
            this.zzbub = j;
        }
    ...
    class C06634 implements Runnable {
        ...
        C06634(zzatu com_google_android_gms_internal_zzatu, String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
            this.zzbua = com_google_android_gms_internal_zzatu;
            this.zzbuc = str;
            this.val$name = str2;
            this.zzbud = j;
    ...
    class C06645 implements Runnable {
        ...
        C06645(zzatu com_google_android_gms_internal_zzatu, String str, String str2, Object obj, long j) {
            this.zzbua = com_google_android_gms_internal_zzatu;
            this.zzbuc = str;
            this.val$name = str2;
            this.zzbui = obj;
    ...
    class C06656 implements Runnable {
        final /* synthetic */ zzatu zzbua;
        final /* synthetic */ AtomicReference zzbuj;
        final /* synthetic */ boolean zzbuk;

        C06656(zzatu com_google_android_gms_internal_zzatu, AtomicReference atomicReference, boolean z) {
            this.zzbua = com_google_android_gms_internal_zzatu;
    ...
    class C06667 implements Runnable {
        final /* synthetic */ zzatu zzbua;
        final /* synthetic */ AtomicReference zzbuj;

        C06667(zzatu com_google_android_gms_internal_zzatu, AtomicReference atomicReference) {
            this.zzbua = com_google_android_gms_internal_zzatu;
            this.zzbuj = atomicReference;
        }
    ...
    public void setMeasurementEnabled(boolean z) {
        zznA();
        zzJe();
        zzJs().zzm(new C06601(this, z));
    }

    public void setMinimumSessionDuration(long j) {
        zzJe();
        zzJs().zzm(new C06612(this, j));
    }

    public void setSessionTimeoutDuration(long j) {
        zzJe();
        zzJs().zzm(new C06623(this, j));
    }
    ...
    protected void zza(String str, String str2, long j, Bundle bundle, boolean z, boolean z2, boolean z3, String str3) {
        zzJs().zzm(new C06634(this, str, str2, j, bundle != null ? new Bundle(bundle) : new Bundle(), z, z2, z3, str3));
    }

    void zza(String str, String str2, long j, Object obj) {
        zzJs().zzm(new C06645(this, str, str2, obj, j));
    }
    ...
    public List<zzaub> zzaI(boolean z) {
        ...
        synchronized (atomicReference) {
            this.zzbpw.zzJs().zzm(new C06656(this, atomicReference, z));
            try {
    ...
    public synchronized String zzfS(String str) {
        ...
        synchronized (this) {
            ...
            if (zzJs().zzLr()) {
                ...
                AtomicReference atomicReference = new AtomicReference();
                synchronized (atomicReference) {
                    this.zzbpw.zzJs().zzm(new C06667(this, atomicReference));
                    try {
