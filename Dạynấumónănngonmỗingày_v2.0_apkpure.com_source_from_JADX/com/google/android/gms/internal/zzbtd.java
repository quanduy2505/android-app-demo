...
public final class zzbtd extends zzbsd<Date> {
    ...
    private final DateFormat zzcox;

    /* renamed from: com.google.android.gms.internal.zzbtd.1 */
    static class C12021 implements zzbse {
        C12021() {
        }
    ...
    public zzbtd() {
        this.zzcox = new SimpleDateFormat("MMM d, yyyy");
    }
