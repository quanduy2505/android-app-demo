...
public class GoogleCloudMessaging {
    ...
    public static int zzbfW;
    public static int zzbfX;
    public static int zzbfY;
    static GoogleCloudMessaging zzbfZ;
    private static final AtomicInteger zzbgc;
    private PendingIntent zzbga;
    private Map<String, Handler> zzbgb;
    private final BlockingQueue<Intent> zzbgd;
    final Messenger zzbge;
    ...
    class C06151 extends Handler {
        ...
        C06151(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
            this.zzbgf = googleCloudMessaging;
            super(looper);
        }
    ...
    static {
        ...
        zzbfX = 6500000;
        zzbfY = 7000000;
        zzbgc = new AtomicInteger(1);
    }

    public GoogleCloudMessaging() {
        this.zzbgd = new LinkedBlockingQueue();
        this.zzbgb = Collections.synchronizedMap(new HashMap());
        this.zzbge = new Messenger(new C06151(this, Looper.getMainLooper()));
    }
    ...
    private String zzeI(String str) {
        ...
        return InstanceID.getInstance(this.zzqr).zzGv().zzh(BuildConfig.VERSION_NAME, str, INSTANCE_ID_SCOPE);
    }
