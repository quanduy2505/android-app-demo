...
public abstract class Task implements ReflectedParcelable {
    ...
    Task(Parcel parcel) {
        ...
        this.zzbgs = parcel.readInt() == NETWORK_STATE_UNMETERED;
        if (parcel.readInt() != NETWORK_STATE_UNMETERED) {
            z = false;
        }
        this.zzbgt = z;
        this.zzbgu = NETWORK_STATE_ANY;
        this.zzbgv = false;
        this.zzbgw = false;
    ...
    public static void zza(zzc com_google_android_gms_gcm_zzc) {
        if (com_google_android_gms_gcm_zzc != null) {
            ...
            if (zzGg == NETWORK_STATE_UNMETERED || zzGg == 0) {
                ...
                } else if (zzGg == NETWORK_STATE_UNMETERED && zzGh < 10) {
    ...
    public void toBundle(Bundle bundle) {
        ...
        bundle.putString(NotificationCompatApi24.CATEGORY_SERVICE, this.zzbgr);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.zzbgs ? NETWORK_STATE_UNMETERED : NETWORK_STATE_CONNECTED);
        if (!this.zzbgt) {
