...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzyf() {
        ...
        String join = zzyk() == null ? BuildConfig.VERSION_NAME : TextUtils.join(",", zzyk());
        String valueOf5 = String.valueOf("\t");
        int zzyn = zzyn();
        String valueOf6 = String.valueOf("\t");
        String zzyh = zzyh() == null ? BuildConfig.VERSION_NAME : zzyh();
        String valueOf7 = String.valueOf("\t");
        String zzyo = zzyo() == null ? BuildConfig.VERSION_NAME : zzyo();
        String valueOf8 = String.valueOf("\t");
        float zzyp = zzyp();
        String valueOf9 = String.valueOf("\t");
        String zzyi = zzyi() == null ? BuildConfig.VERSION_NAME : zzyi();
