...
public class zzc {
    ...
    class C06241 extends Handler {
        final /* synthetic */ zzc zzbhC;

        C06241(zzc com_google_android_gms_iid_zzc, Looper looper) {
            this.zzbhC = com_google_android_gms_iid_zzc;
            super(looper);
        }
    ...
    private void zzeJ(String str) {
        if ("com.google.android.gsf".equals(zzbhq)) {
            ...
            if (this.zzbhz >= 3) {
                if (this.zzbhz == 3) {
                    this.zzbhA = new Random().nextInt(PointerIconCompat.TYPE_DEFAULT) + PointerIconCompat.TYPE_DEFAULT;
                }
                this.zzbhA *= 2;
    ...
    void zzGy() {
        if (this.zzbge == null) {
            zzbi(this.zzqr);
            this.zzbge = new Messenger(new C06241(this, Looper.getMainLooper()));
        }
    }
    ...
    void zzu(Intent intent) {
        ...
        if (stringExtra.startsWith("|")) {
            ...
            intent.putExtra(NativeProtocol.BRIDGE_ARG_ERROR_BUNDLE, valueOf);
        } else {
            valueOf2 = null;
            valueOf = stringExtra;
        }
        ...
        if (longExtra > 0) {
            ...
            this.zzbhA = ((int) longExtra) * PointerIconCompat.TYPE_DEFAULT;
            this.zzbhB = SystemClock.elapsedRealtime() + ((long) this.zzbhA);
