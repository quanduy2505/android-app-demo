...
public class GoogleSignInOptions extends zza implements Optional, ReflectedParcelable {
    ...
    class C06011 implements Comparator<Scope> {
        C06011() {
        }
    ...
    public static final class Builder {
        ...
        public GoogleSignInOptions build() {
            ...
            return new GoogleSignInOptions(this.zzagg, this.zzajh, this.zzaji, this.zzajj, this.zzajk, this.zzajl, null);
        }
