...
public class FirebaseApp {
    ...
    private static final List<String> zzbUz;
    static final Map<String, FirebaseApp> zzbha;
    private static final Object zztU;
    private final String mName;
    private final FirebaseOptions zzbUD;
    private final AtomicBoolean zzbUE;
    private final AtomicBoolean zzbUF;
    private final List<zza> zzbUG;
    private final List<zzb> zzbUH;
    ...
    private static class zzc extends BroadcastReceiver {
        private static AtomicReference<zzc> zzbUK;
        private final Context zzvZ;

        static {
            zzbUK = new AtomicReference();
        }
    ...
    static {
        zzbUy = Arrays.asList(new String[]{"com.google.firebase.auth.FirebaseAuth", "com.google.firebase.iid.FirebaseInstanceId"});
        zzbUz = Collections.singletonList("com.google.firebase.crash.FirebaseCrash");
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        this.zzbUE = new AtomicBoolean(false);
        this.zzbUF = new AtomicBoolean();
        this.zzbUG = new CopyOnWriteArrayList();
        this.zzbUH = new CopyOnWriteArrayList();
        this.zzbUI = new CopyOnWriteArrayList();
    ...
    public String toString() {
        return zzaa.zzv(this).zzg(ShareConstants.WEB_DIALOG_PARAM_NAME, this.mName).zzg("options", this.zzbUD).toString();
    }
