...
public class zzg {
    ...
    private final SimpleArrayMap<String, String> zzcjf;
    private Boolean zzcjg;
    @VisibleForTesting
    final Queue<Intent> zzcjh;
    @VisibleForTesting
    final Queue<Intent> zzcji;

    private zzg() {
        this.zzcjf = new SimpleArrayMap();
        this.zzcjg = null;
        this.zzcjh = new LinkedList();
        this.zzcji = new LinkedList();
    }
