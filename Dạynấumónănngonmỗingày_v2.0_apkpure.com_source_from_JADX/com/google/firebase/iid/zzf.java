...
public class zzf {
    ...
    class C07211 extends Handler {
        ...
        C07211(zzf com_google_firebase_iid_zzf, Looper looper) {
            this.zzcjd = com_google_firebase_iid_zzf;
            super(looper);
        }
    ...
    void zzGy() {
        if (this.zzbge == null) {
            zzbi(this.zzqr);
            this.zzbge = new Messenger(new C07211(this, Looper.getMainLooper()));
        }
    }
