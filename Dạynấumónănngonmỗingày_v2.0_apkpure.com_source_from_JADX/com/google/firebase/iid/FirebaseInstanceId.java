...
public class FirebaseInstanceId {
    private static Map<String, FirebaseInstanceId> zzbha;
    ...
    static String zza(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & 15) + C0801R.styleable.AppCompatTheme_spinnerStyle) & MotionEventCompat.ACTION_MASK);
    ...
    @Nullable
    zza zzaad() {
        return this.zzciS.zzaag().zzq(BuildConfig.VERSION_NAME, this.zzciT, "*");
    }
