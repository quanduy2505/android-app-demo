...
class zza {
    ...
    private final AtomicInteger zzcjn;

    private zza(Context context) {
        this.zzcjn = new AtomicInteger((int) SystemClock.elapsedRealtime());
    ...
    private Bundle zzaar() {
        ...
        try {
            applicationInfo = this.mContext.getPackageManager().getApplicationInfo(this.mContext.getPackageName(), TransportMediator.FLAG_KEY_MEDIA_NEXT);
