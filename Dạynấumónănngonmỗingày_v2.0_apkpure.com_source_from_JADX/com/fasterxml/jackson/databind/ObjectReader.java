...
public class ObjectReader extends ObjectCodec implements Versioned, Serializable {
    ...
    protected Object _bind(JsonParser jsonParser, Object obj) throws IOException, JsonParseException, JsonMappingException {
    ...
    protected Object _bindAndClose(JsonParser jsonParser, Object obj) throws IOException, JsonParseException, JsonMappingException {
        if (this._schema != null) {
    ...
    protected <T> MappingIterator<T> _bindAndReadValues(JsonParser jsonParser, Object obj) throws IOException, JsonProcessingException {
        if (this._schema != null) {
            jsonParser.setSchema(this._schema);
        }
