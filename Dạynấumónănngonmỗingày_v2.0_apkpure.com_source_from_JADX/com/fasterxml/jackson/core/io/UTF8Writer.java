...
public final class UTF8Writer extends Writer {
        ...
        if (i2 >= 2) {
            ...
            while (i6 < i5) {
                ...
                if (i9 < ItemAnimator.FLAG_MOVED) {
                    ...
                    i3 = i7 + 1;
                    bArr[i7] = (byte) ((i9 & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                } else if (i9 < SURR1_FIRST || i9 > SURR2_LAST) {
                    i7 = i3 + 1;
                    bArr[i3] = (byte) ((i9 >> 12) | 224);
                    i8 = i7 + 1;
                    bArr[i7] = (byte) (((i9 >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    i3 = i8 + 1;
                    bArr[i8] = (byte) ((i9 & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                } else {
                    if (i9 > SURR1_LAST) {
                        this._outPtr = i3;
                        illegalSurrogate(i9);
                    ...
                    i3 = i7 + 1;
                    bArr[i7] = (byte) (((i6 >> 12) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    i7 = i3 + 1;
                    bArr[i3] = (byte) (((i6 >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    i3 = i7 + 1;
                    bArr[i7] = (byte) ((i6 & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    i6 = i9;
                }
            }
            this._outPtr = i3;
    ...
    public void write(int i) throws IOException {
        ...
        if (i < TransportMediator.FLAG_KEY_MEDIA_NEXT) {
            byte[] bArr = this._outBuffer;
            int i2 = this._outPtr;
            this._outPtr = i2 + 1;
            bArr[i2] = (byte) i;
        ...
        if (i < ItemAnimator.FLAG_MOVED) {
            ...
            i3 = i4 + 1;
            this._outBuffer[i4] = (byte) ((i & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
        } else if (i <= SupportMenu.USER_MASK) {
            i4 = i3 + 1;
            this._outBuffer[i3] = (byte) ((i >> 12) | 224);
            i2 = i4 + 1;
            this._outBuffer[i4] = (byte) (((i >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) ((i & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
        } else {
            if (i > 1114111) {
                illegalSurrogate(i);
            }
            ...
            i2 = i4 + 1;
            this._outBuffer[i4] = (byte) (((i >> 12) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i4 = i2 + 1;
            this._outBuffer[i2] = (byte) (((i >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i3 = i4 + 1;
            this._outBuffer[i4] = (byte) ((i & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
        }
        this._outPtr = i3;
