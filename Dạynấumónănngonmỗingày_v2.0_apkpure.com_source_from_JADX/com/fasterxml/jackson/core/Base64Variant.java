...
public final class Base64Variant implements Serializable {
    ...
    public String encode(byte[] bArr, boolean z) {
        ...
        while (i2 <= i3) {
            ...
            int i4 = i + 1;
            i = i4 + 1;
            encodeBase64Chunk(stringBuilder, (((bArr[i2] << 8) | (bArr[i] & MotionEventCompat.ACTION_MASK)) << 8) | (bArr[i4] & MotionEventCompat.ACTION_MASK));
        ...
        if (i > 0) {
            ...
            if (i == 2) {
                ...
                i2 |= (bArr[maxLineLength] & MotionEventCompat.ACTION_MASK) << 8;
            }
