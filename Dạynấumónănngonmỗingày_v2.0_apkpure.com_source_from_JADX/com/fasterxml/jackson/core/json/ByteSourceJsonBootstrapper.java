...
public final class ByteSourceJsonBootstrapper {
    ...
    public Reader constructReader() throws IOException {
        ...
        switch (C04881.$SwitchMap$com$fasterxml$jackson$core$JsonEncoding[encoding.ordinal()]) {
    ...
    public static MatchStrength hasJSONFormat(InputAccessor inputAccessor) throws IOException {
        ...
        if (skipSpace == 123) {
            ...
            if (skipSpace == 45) {
                ...
                return matchStrength;
            } else if (skipSpace == C0801R.styleable.AppCompatTheme_ratingBarStyleSmall) {
                return tryMatch(inputAccessor, "ull", matchStrength);
            } else {
                if (skipSpace == 116) {
                    return tryMatch(inputAccessor, "rue", matchStrength);
                }
                if (skipSpace == HttpStatus.SC_PROCESSING) {
