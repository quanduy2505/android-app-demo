...
class GetTokenLoginMethodHandler extends LoginMethodHandler {
    ...
    static class C04353 implements Creator {
        C04353() {
        }
    ...
    class C10071 implements CompletedListener {
        final /* synthetic */ Request val$request;

        C10071(Request request) {
    ...
    class C10082 implements GraphMeRequestWithCacheCallback {
        final /* synthetic */ Request val$request;
        final /* synthetic */ Bundle val$result;

        C10082(Bundle bundle, Request request) {
        ...
        public void onSuccess(JSONObject userInfo) {
            try {
                this.val$result.putString(NativeProtocol.EXTRA_USER_ID, userInfo.getString(ShareConstants.WEB_DIALOG_PARAM_ID));
    ...
    boolean tryAuthorize(Request request) {
        ...
        this.getTokenClient.setCompletedListener(new C10071(request));
        return true;
    }
    ...
    void complete(Request request, Bundle result) {
        ...
        if (userId == null || userId.isEmpty()) {
            this.loginClient.notifyBackgroundProcessingStart();
            Utility.getGraphMeRequestWithCacheAsync(result.getString(NativeProtocol.EXTRA_ACCESS_TOKEN), new C10082(result, request));
            return;
        }
