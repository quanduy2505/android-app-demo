...
class LoginLogger {
    ...
    static Bundle newAuthorizationLoggingBundle(String authLoggerId) {
        ...
        bundle.putString(EVENT_PARAM_METHOD, BuildConfig.VERSION_NAME);
        bundle.putString(EVENT_PARAM_LOGIN_RESULT, BuildConfig.VERSION_NAME);
        bundle.putString(EVENT_PARAM_ERROR_MESSAGE, BuildConfig.VERSION_NAME);
        bundle.putString(EVENT_PARAM_ERROR_CODE, BuildConfig.VERSION_NAME);
        bundle.putString(EVENT_PARAM_EXTRAS, BuildConfig.VERSION_NAME);
        return bundle;
    }
    ...
    public void logUnexpectedError(String eventName, String errorMessage) {
        logUnexpectedError(eventName, errorMessage, BuildConfig.VERSION_NAME);
    }

    public void logUnexpectedError(String eventName, String errorMessage, String method) {
        Bundle bundle = newAuthorizationLoggingBundle(BuildConfig.VERSION_NAME);
