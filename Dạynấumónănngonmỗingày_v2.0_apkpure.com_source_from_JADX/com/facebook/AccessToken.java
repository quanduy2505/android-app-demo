...
public final class AccessToken implements Parcelable {
    ...
    static class C03622 implements Creator {
        C03622() {
        }
    ...
    static class C09781 implements GraphMeRequestWithCacheCallback {
        final /* synthetic */ AccessTokenCreationCallback val$accessTokenCallback;
        final /* synthetic */ String val$applicationId;
        final /* synthetic */ Bundle val$extras;

        C09781(Bundle bundle, AccessTokenCreationCallback accessTokenCreationCallback, String str) {
        ...
        public void onSuccess(JSONObject userInfo) {
            try {
                this.val$extras.putString(AccessToken.USER_ID_KEY, userInfo.getString(ShareConstants.WEB_DIALOG_PARAM_ID));
        ...
        public void onFailure(FacebookException error) {
            this.val$accessTokenCallback.onError(error);
        }
    }
    ...
    public static void createFromNativeLinkingIntent(Intent intent, String applicationId, AccessTokenCreationCallback accessTokenCallback) {
        ...
        if (userId == null || userId.isEmpty()) {
            Utility.getGraphMeRequestWithCacheAsync(accessToken, new C09781(extras, accessTokenCallback, applicationId));
        } else {
    ...
    static AccessToken createFromJSONObject(JSONObject jsonObject) throws JSONException {
        if (jsonObject.getInt(VERSION_KEY) > CURRENT_JSON_FORMAT) {
        ...
        return new AccessToken(token, jsonObject.getString(APPLICATION_ID_KEY), jsonObject.getString(USER_ID_KEY), Utility.jsonArrayToStringList(permissionsArray), Utility.jsonArrayToStringList(declinedPermissionsArray), AccessTokenSource.valueOf(jsonObject.getString(SOURCE_KEY)), expiresAt, lastRefresh);
    }
