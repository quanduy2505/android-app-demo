...
public class VideoUploader {
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        class C04642 implements Runnable {
            ...
            C04642(FacebookException facebookException, String str) {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            VideoUploader.getHandler().postDelayed(new C04631(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
        ...
        protected void issueResponseOnMainThread(FacebookException error, String videoId) {
            VideoUploader.getHandler().post(new C04642(error, videoId));
        }
    }

    /* renamed from: com.facebook.share.internal.VideoUploader.1 */
    static class C10461 extends AccessTokenTracker {
        C10461() {
        }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        ...
        static class C04601 extends HashSet<Integer> {
            C04601() {
        ...
        static {
            transientErrorCodes = new C04601();
        }
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        ...
        static class C04611 extends HashSet<Integer> {
            C04611() {
        ...
        static {
            transientErrorCodes = new C04611();
        }
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        ...
        static class C04621 extends HashSet<Integer> {
            C04621() {
        ...
        static {
            transientErrorCodes = new C04621();
        }
    ...
    public static synchronized void uploadAsync(ShareVideoContent videoContent, String graphNode, FacebookCallback<Result> callback) throws FileNotFoundException {
        synchronized (VideoUploader.class) {
            ...
            UploadContext uploadContext = new UploadContext(graphNode, callback, null);
    ...
    private static byte[] getChunk(UploadContext uploadContext, String chunkStart, String chunkEnd) throws IOException {
        if (Utility.areObjectsEqual(chunkStart, uploadContext.chunkStart)) {
            ...
            byte[] buffer = new byte[Math.min(Utility.DEFAULT_STREAM_BUFFER_SIZE, chunkSize)];
            do {
