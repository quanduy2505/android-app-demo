...
public final class ShareInternalUtility {
    ...
    static class C10381 extends ResultProcessor {
        final /* synthetic */ FacebookCallback val$callback;

        C10381(FacebookCallback callback, FacebookCallback facebookCallback) {
    ...
    static class C10392 implements Callback {
    ...
    static class C10403 implements Callback {
        final /* synthetic */ FacebookCallback val$callback;
        final /* synthetic */ int val$requestCode;

        C10403(int i, FacebookCallback facebookCallback) {
            this.val$requestCode = i;
            this.val$callback = facebookCallback;
        }
    ...
    static class C10414 implements Mapper<SharePhoto, Attachment> {
    ...
    static class C10425 implements Mapper<Attachment, String> {
        C10425() {
        }
    ...
    static class C10436 implements Mapper<ShareMedia, Bundle> {
        final /* synthetic */ UUID val$appCallId;
        final /* synthetic */ List val$attachments;

        C10436(UUID uuid, List list) {
            this.val$appCallId = uuid;
    ...
    static class C10447 implements PhotoJSONProcessor {
        final /* synthetic */ ArrayList val$attachments;
        final /* synthetic */ UUID val$callId;

        C10447(UUID uuid, ArrayList arrayList) {
        ...
        public JSONObject toJSONObject(SharePhoto photo) {
            ...
            try {
                photoJSONObject.put(NativeProtocol.WEB_DIALOG_URL, attachment.getAttachmentUrl());
    ...
    static class C10458 implements PhotoJSONProcessor {
        C10458() {
        }
    ...
    public static ResultProcessor getShareResultProcessor(FacebookCallback<Result> callback) {
        return new C10381(callback, callback);
    }
    ...
    public static void registerStaticShareCallback(int requestCode) {
        CallbackManagerImpl.registerStaticCallback(requestCode, new C10392(requestCode));
    }
    ...
    public static void registerSharerCallback(int requestCode, CallbackManager callbackManager, FacebookCallback<Result> callback) {
        if (callbackManager instanceof CallbackManagerImpl) {
            ((CallbackManagerImpl) callbackManager).registerCallback(requestCode, new C10403(requestCode, callback));
            return;
        }
    ...
    public static List<String> getPhotoUrls(SharePhotoContent photoContent, UUID appCallId) {
        if (photoContent != null) {
            ...
            if (photos != null) {
                List<Attachment> attachments = Utility.map(photos, new C10414(appCallId));
                List<String> attachmentUrls = Utility.map(attachments, new C10425());
    ...
    public static List<Bundle> getMediaInfos(ShareMediaContent mediaContent, UUID appCallId) {
        if (mediaContent != null) {
            ...
            if (media != null) {
                ...
                List<Bundle> mediaInfos = Utility.map(media, new C10436(appCallId, attachments));
                NativeAppCallAttachmentStore.addAttachments(attachments);
                return mediaInfos;
            }
        }
    ...
    public static JSONObject toJSONObjectForCall(UUID callId, ShareOpenGraphContent content) throws JSONException {
        ...
        JSONObject actionJSON = OpenGraphJSONUtility.toJSONObject(action, new C10447(callId, attachments));
        NativeAppCallAttachmentStore.addAttachments(attachments);
    ...
    public static JSONObject toJSONObjectForWeb(ShareOpenGraphContent shareOpenGraphContent) throws JSONException {
        return OpenGraphJSONUtility.toJSONObject(shareOpenGraphContent.getAction(), new C10458());
    }
