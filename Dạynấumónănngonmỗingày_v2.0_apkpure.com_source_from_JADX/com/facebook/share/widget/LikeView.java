...
public class LikeView extends FrameLayout {
    ...
    static /* synthetic */ class C04802 {
        static final /* synthetic */ int[] f6x30689ac;

        static {
            f6x30689ac = new int[AuxiliaryViewPosition.values().length];
            try {
                f6x30689ac[AuxiliaryViewPosition.TOP.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f6x30689ac[AuxiliaryViewPosition.BOTTOM.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f6x30689ac[AuxiliaryViewPosition.INLINE.ordinal()] = 3;
    ...
    private void parseAttributes(AttributeSet attrs) {
        if (attrs != null && getContext() != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0378R.styleable.com_facebook_like_view);
            if (a != null) {
                this.objectId = Utility.coerceValueIfNullOrEmpty(a.getString(C0378R.styleable.com_facebook_like_view_com_facebook_object_id), null);
                this.objectType = ObjectType.fromInt(a.getInt(C0378R.styleable.com_facebook_like_view_com_facebook_object_type, ObjectType.DEFAULT.getValue()));
                this.likeViewStyle = Style.fromInt(a.getInt(C0378R.styleable.com_facebook_like_view_com_facebook_style, Style.DEFAULT.getValue()));
                if (this.likeViewStyle == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'style'");
                }
                this.auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(a.getInt(C0378R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
                if (this.auxiliaryViewPosition == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'auxiliary_view_position'");
                }
                this.horizontalAlignment = HorizontalAlignment.fromInt(a.getInt(C0378R.styleable.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
                if (this.horizontalAlignment == null) {
                    throw new IllegalArgumentException("Unsupported value for LikeView 'horizontal_alignment'");
                }
                this.foregroundColor = a.getColor(C0378R.styleable.com_facebook_like_view_com_facebook_foreground_color, NO_FOREGROUND_COLOR);
                a.recycle();
            }
        }
    }
    ...
    private void initialize(Context context) {
        this.edgePadding = getResources().getDimensionPixelSize(C0378R.dimen.com_facebook_likeview_edge_padding);
        this.internalPadding = getResources().getDimensionPixelSize(C0378R.dimen.com_facebook_likeview_internal_padding);
        if (this.foregroundColor == NO_FOREGROUND_COLOR) {
            this.foregroundColor = getResources().getColor(C0378R.color.com_facebook_likeview_text_color);
        }
    ...
    private void initializeLikeButton(Context context) {
        ...
        this.likeButton.setOnClickListener(new C04791());
        this.likeButton.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
    }

    private void initializeSocialSentenceView(Context context) {
        this.socialSentenceView = new TextView(context);
        this.socialSentenceView.setTextSize(0, getResources().getDimension(C0378R.dimen.com_facebook_likeview_text_size));
    ...
    private Bundle getAnalyticsParameters() {
        ...
        params.putString(ShareConstants.WEB_DIALOG_PARAM_OBJECT_ID, Utility.coerceValueIfNullOrEmpty(this.objectId, BuildConfig.VERSION_NAME));
    ...
    private void updateLayout() {
        ...
        switch (C04802.f6x30689ac[this.auxiliaryViewPosition.ordinal()]) {
