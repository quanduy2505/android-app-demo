...
public class MessengerUtils {
    ...
    private static Set<Integer> getAllAvailableProtocolVersions(Context context) {
        ...
        Cursor c = contentResolver.query(Uri.parse("content://com.facebook.orca.provider.MessengerPlatformProvider/versions"), new String[]{ClientCookie.VERSION_ATTR}, null, null, null);
        if (c != null) {
            try {
                int versionColumnIndex = c.getColumnIndex(ClientCookie.VERSION_ATTR);
                while (c.moveToNext()) {
