...
public class BundleJSONConverter {
    ...
    static class C09921 implements Setter {
        C09921() {
        }
    ...
    static class C09932 implements Setter {
        C09932() {
        }
    ...
    static class C09943 implements Setter {
        C09943() {
        }
    ...
    static class C09954 implements Setter {
        C09954() {
        }
    ...
    static class C09965 implements Setter {
        C09965() {
        }
    ...
    static class C09976 implements Setter {
        C09976() {
        }
    ...
    static class C09987 implements Setter {
        C09987() {
        }
    ...
    static {
        SETTERS = new HashMap();
        SETTERS.put(Boolean.class, new C09921());
        SETTERS.put(Integer.class, new C09932());
        SETTERS.put(Long.class, new C09943());
        SETTERS.put(Double.class, new C09954());
        SETTERS.put(String.class, new C09965());
        SETTERS.put(String[].class, new C09976());
        SETTERS.put(JSONArray.class, new C09987());
    }
