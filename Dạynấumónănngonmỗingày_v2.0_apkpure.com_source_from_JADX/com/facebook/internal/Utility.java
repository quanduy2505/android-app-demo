...
public final class Utility {
    ...
    static class C04212 implements FilenameFilter {
        C04212() {
        }
    ...
    static class C10021 implements Callback {
        final /* synthetic */ String val$accessToken;
        final /* synthetic */ GraphMeRequestWithCacheCallback val$callback;

        C10021(GraphMeRequestWithCacheCallback graphMeRequestWithCacheCallback, String str) {
    ...
    static {
        ...
        deviceTimezoneAbbreviation = BuildConfig.VERSION_NAME;
        deviceTimeZoneName = BuildConfig.VERSION_NAME;
    ...
    public static int[] intersectRanges(int[] range1, int[] range2) {
        ...
        while (index1 < range1.length && index2 < range2.length) {
            int newRangeLower = Target.SIZE_ORIGINAL;
            int newRangeUpper = UrlImageViewHelper.CACHE_DURATION_INFINITE;
            int lower1 = range1[index1];
            int upper1 = UrlImageViewHelper.CACHE_DURATION_INFINITE;
            int lower2 = range2[index2];
            int upper2 = UrlImageViewHelper.CACHE_DURATION_INFINITE;
            ...
            if (newRangeLower != Target.SIZE_ORIGINAL) {
                int outputIndex2 = outputIndex + 1;
                outputRange[outputIndex] = newRangeLower;
                if (newRangeUpper == UrlImageViewHelper.CACHE_DURATION_INFINITE) {
            ...
            for (String parameter : queryString.split("&")) {
                ...
                try {
                    if (keyValuePair.length == 2) {
                        ...
                        params.putString(URLDecoder.decode(keyValuePair[0], UTF8), BuildConfig.VERSION_NAME);
                    }
                } catch (Exception e) {
                    logd(LOG_TAG, e);
                }
    ...
    public static void putCommaSeparatedStringList(Bundle b, String key, List<String> list) {
        if (list != null) {
            ...
            String commaSeparated = BuildConfig.VERSION_NAME;
            if (builder.length() > 0) {
    ...
    public static String readStreamToString(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            try {
                ...
                char[] buffer = new char[ItemAnimator.FLAG_MOVED];
                while (true) {
    ...
    public static String safeGetStringFromResponse(JSONObject response, String propertyName) {
        return response != null ? response.optString(propertyName, BuildConfig.VERSION_NAME) : BuildConfig.VERSION_NAME;
    }
    ...
    public static void getGraphMeRequestWithCacheAsync(String accessToken, GraphMeRequestWithCacheCallback callback) {
        ...
        Callback graphCallback = new C10021(callback, accessToken);
    ...
    private static int refreshBestGuessNumberOfCPUCores() {
        ...
        try {
            File[] cpuFiles = new File("/sys/devices/system/cpu/").listFiles(new C04212());
            if (cpuFiles != null) {
    ...
    public static PermissionsPair handlePermissionResponse(JSONObject result) throws JSONException {
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            if (!(permission == null || permission.equals("installed"))) {
                String status = object.optString(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_STATUS);
                if (status != null) {
