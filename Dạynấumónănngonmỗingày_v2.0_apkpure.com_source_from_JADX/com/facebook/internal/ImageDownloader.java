...
public class ImageDownloader {
    ...
    static class C04151 implements Runnable {
        ...
        C04151(ImageRequest imageRequest, Exception exception, boolean z, Bitmap bitmap, Callback callback) {
    ...
    static {
        downloadQueue = new WorkQueue(DOWNLOAD_QUEUE_MAX_CONCURRENT);
        cacheReadQueue = new WorkQueue(CACHE_READ_QUEUE_MAX_CONCURRENT);
    ...
    private static void issueResponse(RequestKey key, Exception error, Bitmap bitmap, boolean isCachedRedirect) {
        ...
        if (completedRequestContext != null && !completedRequestContext.isCancelled) {
            ...
            if (callback != null) {
                getHandler().post(new C04151(request, error, isCachedRedirect, bitmap, callback));
            }
        }
    }
    ...
    L_0x00c3:
        ...
        goto L_0x00ae;
    L_0x00cf:
        r16 = com.facebook.C0378R.string.com_facebook_image_download_unknown_error;	 Catch:{ IOException -> 0x0058, all -> 0x00df }
        r0 = r20;
        r1 = r16;
