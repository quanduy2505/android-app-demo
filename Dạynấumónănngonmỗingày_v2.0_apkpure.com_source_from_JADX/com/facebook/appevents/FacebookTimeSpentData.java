...
class FacebookTimeSpentData implements Serializable {
    ...
    private static class SerializationProxyV1 implements Serializable {
        ...
        private Object readResolve() {
            return new FacebookTimeSpentData(this.lastSuspendTime, this.millisecondsSpentInSession, this.interruptionCount, null);
        }
    }
    ...
    private static class SerializationProxyV2 implements Serializable {
        ...
        private Object readResolve() {
            return new FacebookTimeSpentData(this.lastSuspendTime, this.millisecondsSpentInSession, this.interruptionCount, this.firstOpenSourceApplication, null);
        }
    }

    static {
        TAG = FacebookTimeSpentData.class.getCanonicalName();
        INACTIVE_SECONDS_QUANTA = new long[]{APP_ACTIVATE_SUPPRESSION_PERIOD_IN_MILLISECONDS, 900000, 1800000, 3600000, 21600000, 43200000, 86400000, 172800000, 259200000, 604800000, 1209600000, 1814400000, 2419200000L, 5184000000L, 7776000000L, 10368000000L, 12960000000L, 15552000000L, 31536000000L};
    }
    ...
    private void resetSession() {
        this.isAppActive = false;
        this.lastResumeTime = FIRST_TIME_LOAD_RESUME_TIME;
        this.lastSuspendTime = FIRST_TIME_LOAD_RESUME_TIME;
        this.interruptionCount = 0;
        this.millisecondsSpentInSession = 0;
    }

    private boolean wasSuspendedEver() {
        return this.lastSuspendTime != FIRST_TIME_LOAD_RESUME_TIME;
    }
