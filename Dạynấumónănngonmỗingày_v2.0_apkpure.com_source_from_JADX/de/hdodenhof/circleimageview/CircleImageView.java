...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = 0;
        this.mFillColor = 0;
        TypedArray a = context.obtainStyledAttributes(attrs, C0785R.styleable.CircleImageView, defStyle, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C0785R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = a.getColor(C0785R.styleable.CircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
        this.mBorderOverlay = a.getBoolean(C0785R.styleable.CircleImageView_civ_border_overlay, false);
        this.mFillColor = a.getColor(C0785R.styleable.CircleImageView_civ_fill_color, 0);
        a.recycle();
        init();
    }
