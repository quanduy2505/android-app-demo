...
public class BasicHttpRequest extends AbstractHttpMessage implements HttpRequest {
    ...
    public String toString() {
        return new StringBuffer().append(this.method).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(this.uri).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(this.headergroup).toString();
    }
}
