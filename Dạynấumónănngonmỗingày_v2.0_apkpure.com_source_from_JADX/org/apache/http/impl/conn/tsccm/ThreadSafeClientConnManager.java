...
public class ThreadSafeClientConnManager implements ClientConnectionManager {
    ...
    class C12381 implements ClientConnectionRequest {
        ...
        C12381(PoolEntryRequest poolEntryRequest, HttpRoute httpRoute) throws ConnectionPoolTimeoutException, InterruptedException {
    ...
    public ClientConnectionRequest requestConnection(HttpRoute route, Object state) {
        return new C12381(this.pool.requestPoolEntry(route, state), route);
    }
    ...
    public void closeIdleConnections(long idleTimeout, TimeUnit tunit) {
        if (this.log.isDebugEnabled()) {
            this.log.debug("Closing connections idle longer than " + idleTimeout + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + tunit);
        }
