...
public class ConnPoolByRoute extends AbstractConnPool {
    ...
    class C12361 implements PoolEntryRequest {
        ...
        C12361(WaitingThreadAborter waitingThreadAborter, HttpRoute httpRoute, Object obj) throws InterruptedException, ConnectionPoolTimeoutException {
    ...
    public PoolEntryRequest requestPoolEntry(HttpRoute route, Object state) {
        return new C12361(new WaitingThreadAborter(), route, state);
    }
        ...
        try {
            ...
            if (reusable) {
                if (this.log.isDebugEnabled()) {
                    String s;
                    if (validDuration > 0) {
                        s = "for " + validDuration + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + timeUnit;
                    } else {
                        s = "indefinitely";
                    }
    ...
    public void closeIdleConnections(long idletime, TimeUnit tunit) {
        ...
        if (this.log.isDebugEnabled()) {
            this.log.debug("Closing connections idle longer than " + idletime + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + tunit);
        }
